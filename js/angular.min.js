...
(function (P, T, q) {
    ...
    function m(b, a, c)
    {
        ...
        if (b)
        {
            ...
            else
            {
                for (d in b)
                {
                    b.hasOwnProperty(d) && a.call(c, b[d],
                        d);
                }
            }
        }
    ...
    function xa()
    {
        for (var b = aa.length, a; b;)
        {
            ...
            {
                return aa[b] = String.fromCharCode(a + 1), aa.join("")
            }
        }
        aa.unshift("0");
        return aa.join("")
    ...
    function U(b, a)
    {
        ...
        {
            (a = b) && (E(b) ? a = U(b, []) : na(b) ? a = new Date(b.getTime()) : L(b) && (a = U(b, {})));
        }
        return a
    }
        ...
        function c()
        {
            ...
            for (var b = [this], c = a, h, f, i, j, k, l; b.length;)
            {
                ...
                for (i = h.length; f < i; f++)
                {
                    ...
                    k = 0;
                    for (e = (l = j.children()).length, j = e; k < j; k++)
                    {
                        b.push(ca(l[k]))
                    }
                }
    ...
    function bb(b, a)
    {
        if (a)
        {
            for (var a = !a.nodeName && y(a.length) && !oa(a) ? a : [a], c = 0; c < a.length; c++)
            {
                b.push(a[c])
            }
        }
    ...
    function Cb(b)
    {
        ...
        if (typeof b == "function")
        {
            if (!(a = b.$inject))
            {
                a = [], c = b.toString().replace(qc, ""), c = c.match(rc), m(c[1].split(sc), function (b) {
        ...
        {
            E(b) ? (c = b.length - 1, qa(b[c], "fn"), a = b.slice(0, c)) : qa(b, "fn", !0);
        }
        return a
    }
    ...
    function sb(b)
    {
        ...
        function g(a, b)
        {
            ...
            function d(a, b, e)
            {
                ...
                {
                    i = j[h], f.push(e && e.hasOwnProperty(i) ? e[i] : c(i));
                }
                a.$inject || (a = a[g]);
                switch (b ? -1 : f.length)
                {
    ...
    function vc(b, a, c, d)
    {
        ...
        f.url = function (a, b) {
            if (a)
            {
                if (M != a)
                {
                    return M = a, d.history ? b ? k.replaceState(null, "", a) : (k.pushState(null, "", a), A.attr("href", A.attr("href"))) : b ? j.replace(a) : j.href = a, f
                }
            }
            else
            {
        ...
        f.cookies = function (a,
            ...
            if (a)
            {
                if (b === q)
                {
                    i.cookie = escape(a) + "=;path=" + R + ";expires=Thu, 01 Jan 1970 00:00:00 GMT";
                }
                else
                {
                    if (B(b))
                    {
                        d = (i.cookie = escape(a) + "=" + escape(b) + ";path=" + R).length + 1, d > 4096 && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!")
                    }
                }
            }
            else
            {
                if (i.cookie !== $)
                {
                    ...
                    {
                        e = d[f], j = e.indexOf("="), j > 0 && (a = unescape(e.substring(0, j)), r[a] === q && (r[a] = unescape(e.substring(j + 1))))
                    }
                }
                return r
            }
            ...
            function (b,
                ...
                function A(a, b, c, d)
                {
                    function e(a, c, d, g)
                    {
                        ...
                        n = o = 0;
                        for (l = j.length; o < l; n++)
                        {
                            i = t[n], c = j[o++], h = j[o++], c ? (c.scope ? (k = a.$new(L(c.scope)), u(i).data("$scope", k)) : k = a, (p = c.transclude) || !g && b ? c(h, k, i, d, function (b) {
                                return function (c) {
                                    var d = a.$new();
                                    d.$$transcluded = !0;
                    ...
                    for (var j = [], g, h, i, k = 0; k < a.length; k++)
                    {
                        h = new ia, g = N(a[k], [], h, d), h = (g = g.length ? J(g, a[k], h, b, c) : null) && g.terminal || !a[k].childNodes || !a[k].childNodes.length ? null :
                ...
                function N(a, b, c, g)
                {
                    ...
                    switch (a.nodeType)
                    {
                        case 1:
                            ...
                            {
                                if (i = h[p], i.specified)
                                {
                                    k = i.name, o = ea(k.toLowerCase()), j[o] = k, c[o] = i = Q(Z && k == "href" ? decodeURIComponent(a.getAttribute(k, 2)) : i.value), Ab(a, o) && (c[o] = !0), V(a, b, i, o), r(b, o, "A", g);
                                }
                            }
                            a = a.className;
                            if (B(a) && a !== "")
                            {
                                for (; h = e.exec(a);)
                                {
                                    o = ea(h[2]), r(b, o, "C", g) && (c[o] = Q(h[3])), a =
                ...
                function J(a, b, c, d, e)
                {
                    function j(a, b)
                    {
                        if (a)
                        {
                            a.require = r.require, n.push(a);
                        }
                        if (b)
                        {
                            b.require = r.require, t.push(b)
                        }
                    }
                    ...
                    for (var l = -Number.MAX_VALUE, n = [], t = [], s = null, J = null, A = null, D = c.$$element = u(b), r, F, W, ja, V = d, y, w, Y, v = 0, z = a.length; v < z; v++)
                    {
                        ...
                        if (Y = r.scope)
                        {
                            ta("isolated scope", J, r, D), L(Y) && (M(D, "ng-isolate-scope"), J = r), M(D, "ng-scope"), s = s || r;
                        }
                        F = r.name;
                        if (Y = r.controller)
                        {
                            y = y || {}, ta("'" + F + "' controller", y[F], r, D), y[F] = r;
                        }
                        if (Y = r.transclude)
                        {
                            ta("transclusion", ja, r, D), ja = r, l = r.priority, Y == "element" ? (W = u(b), D = c.$$element = u(T.createComment(" " +
                        ...
                        if (r.templateUrl)
                        {
                            ta("template", A, r, D), A = r, i = R(a.splice(v, a.length - v), i, D, c, e, r.replace, V), z = a.length;
                        }
                        else if (r.compile)
                        {
                            try
                        ...
                        if (r.terminal)
                        {
                            i.terminal = !0, l = Math.max(l, r.priority)
                        }
                    }
                    i.scope = s && s.scope;
                    i.transclude = ja && V;
                ...
                function ta(a, b, c, d)
                {
                    if (b)
                    {
                        throw Error("Multiple directives [" +
                ...
                var D = t[0].createElement("a"), W = j.startSymbol(), ja = j.endSymbol(),
                    ...
                    if (!f || o)
                    {
                        return p.length = n, k = function (a) {
                            for (var b = 0, c = n, d; b < c; b++)
                            {
                                ...
                                {
                                    d = d(a), d == null || d == q ? d = "" : typeof d != "string" && (d = da(d));
                                }
                                p[b] = d
                            }
                            return p.join("")
    ...
    {
        var d = va(b);
        if (decodeURIComponent(d.path) == a && !w(d.hash) && d.hash.indexOf(c) === 0)
        {
            return b;
        }
        else
    ...
    function Lc(b, a)
    {
        ...
        function l(a)
        {
            ...
            for (var d = "", e = a, f = !1; p < b.length;)
            {
                ...
                if (f)
                {
                    g == "u" ? (g = b.substring(p + 1, p + 5), g.match(/[\da-f]{4}/i) || i("Invalid unicode escape [\\u" + g + "]"), p += 4, d += String.fromCharCode(parseInt(g, 16))) : (f = Mc[g], d += f ? f : g), f = !1;
                }
                else if (g == "\\")
                {
                    f =
        ...
        for (var n = [], o, p = 0, s = [], t, x = ":"; p < b.length;)
        {
            ...
            {
                if (k(), "{,".indexOf(x) != -1 && s[0] == "{" && (o = n[n.length - 1]))
                {
    ...
    function Nc(b, a, c, d)
    {
        ...
        function A()
        {
            ...
            for (var c; b = f("(", "[", ".");)
            {
                b.text === "(" ? (a = y(a, c), c = null) : b.text === "[" ? (c = a, a = V(a)) : b.text === "." ? (c = a, a = u(a)) : e("IMPOSSIBLE");
            }
            return a
        }
    ...
    function Lb(b, a)
    {
        ...
        if (a)
        {
            e = d < 6 ? Nb(c[0], c[1], c[2], c[3], c[4]) : function (a, b) {
                var e = 0, g;
                do
                {
                    g = Nb(c[e++], c[e++], c[e++], c[e++], c[e++])(a, b), b = q,
                        a = g;
                } while (e < d);
                return g
            };
    ...
    function Rc()
    {
        ...
        this.$get = ["$rootScope",
            ...
            function (a, c, d, e, g, h, f) {
                ...
                {
                    var b = k(), j = o.current;
                    if (b && j && b.$$route === j.$$route && fa(b.pathParams, j.pathParams) && !b.reloadOnSearch && !n)
                    {
                            ...
                            do
                            {
                                ...
                                if (h = x.$$watchers)
                                {
                                    for (p = h.length; p--;)
                                    {
                                        try
                                        {
                                            if (a = h[p], (d = a.get(x)) !== (e = a.last) && !(a.eq ? fa(d, e) : typeof d == "number" && typeof e == "number" && isNaN(d) && isNaN(e)))
                                            {
                                                m = !0, a.last = a.eq ? U(d) : d, a.fn(d, e === f ? d : e, x), t < 5 && (A = 4 - t, q[A] || (q[A] = []), N = H(a.exp) ? "fn: " + (a.exp.name || a.exp.toString()) :
            ...
            function (a, b, c, i, j, k) {
                function l(a)
                {
                    ...
                    var e = a.transformRequest ||
                        d.transformRequest, f = a.transformResponse || d.transformResponse, g = d.headers,
                        g = v({"X-XSRF-TOKEN": b.cookies()["XSRF-TOKEN"]}, g.common, g[z(a.method)], a.headers),
                        e = Qb(a.data, Pb(g), e), i;
        ...
        return function (e, i, j, k, l, n, o) {
            ...
            else
            {
                ...
                t.onreadystatechange = function () {
                    if (t.readyState == 4)
                    {
                        var a = t.getAllResponseHeaders(), b = ["Cache-Control",
                            "Content-Language",
                            "Content-Type",
                            "Expires",
                            "Last-Modified",
    ...
    function Wb(b, a, c, d, e)
    {
        ...
        if (!j)
        {
            ...
            var h = Math.pow(10, e), b = Math.round(b * h) / h, b = ("" + b).split(Xb), h = b[0], b = b[1] || "", j = 0,
                k = a.lgSize,
                l = a.gSize;
            if (h.length >= k + l)
            {
    ...
    function Tb(b)
    {
        ...
        return function (c,
            ...
            for (; e;)
            {
                (i = hd.exec(e)) ? (h = h.concat(ha.call(i, 1)), e = h.pop()) : (h.push(e), e = null);
            }
            m(h, function (a) {
                f = id[a];
    ...
    var z = function (b) {
        ...
        [])[1]), u, ca, ha = [].slice, Pa = [].push, wa = Object.prototype.toString, Ya = P.angular || (P.angular = {}),
        sa, fb, aa = ["0",
            "0",
            "0"];
    C.$inject = [];
    ...
    m({
        ...
        attr: function (b, a, c) {
            ...
            if (Ea[d])
            {
                ...
                {
                    return b[a] || (b.attributes.getNamedItem(a) || C).specified ? d : q;
                }
            }
            else if (y(c))
            {
    ...
    m({
        ...
        K.prototype[c] =
            function (c, e) {
                ...
                {
                    g == q ? (g = a(this[h], c, e), g !== q && (g = u(g))) : bb(g, a(this[h], c, e));
                }
                return g == q ? this : g
            }
    });
    ...
    var rc =
            /^function\s*[^\(]*\(\s*([^\)]*)\)/m, sc = /,/, tc = /^\s*(_?)(\S+?)\1\s*$/,
        qc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Eb = "Non-assignable model expression: ";
    Db.$inject = ["$provide"];
    var Bc = /^(x[\:\-_]|data[\:\-_])/i,
        Hb = /^([^:]+):\/\/(\w+:{0,1}\w*@)?(\{?[\w\.-]*\}?)(:([0-9]+))?(\/[^\?#]*)?(\?([^#]*))?(#(.*))?$/,
        ac = /^([^\?#]*)?(\?([^#]*))?(#(.*))?$/, Ic = ac, Ib = {
    ...
    var Pa = function (a) {
        ...
        od = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$/, pd = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, bc = {
            ...
            }], La = "ng-valid", Ka = "ng-invalid", Na = "ng-pristine", Zb = "ng-dirty", qd = ["$scope",
            "$exceptionHandler",
            "$attrs",
            "$element",
            "$parse",
            function (a, c, d, e, g) {
                ...
                this.$setViewValue = function (d) {
                    ...
                    if (this.$pristine)
                    {
                        this.$dirty = !0, this.$pristine = !1, e.removeClass(Na).addClass(Zb), j.$setDirty();
                    }
                        ...
                        function h()
                        {
                            ...
                            for (w = c.length; x < w; x++)
                            {
                                ...
                                for (y = i.length; z < y; z++)
                                {
                                    ...
                                    {
                                        d.id === "" && t ? E = t : (E = C.clone()).val(d.id).attr("selected", d.selected).text(d.label), u.push({
                                            element: E,
                                            label: d.label,
                                            id: d.id,
                                            selected: d.selected
