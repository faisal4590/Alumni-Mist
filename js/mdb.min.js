        ...
        }, i.extend = function ()
        {
            ...
            for ("boolean" == typeof s && (d = s, s = arguments[l] || {}, l++), "object" != typeof s && "function" !== i.type(s) && (s = {}), l === u && (s = this, l--); u > l; l++)
            {
                if (null != (r = arguments[l]))
                {
                    for (a in r)
                    {
                        t = s[a], n = r[a], s !== n && (d && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1, o = t && i.isArray(t) ? t : []) : o = t && i.isPlainObject(t) ? t : {}, s[a] = i.extend(d, o, n)) : void 0 !== n && (s[a] = n));
                    }
                }
            }
            return s
    ...
    return function (t, e, i, n)
    {
        ...
        function o(t, i, n, a)
        {
            ...
            function d(e)
            {
                ...
                var o = i + (e - x[--a]) / (x[a + 1] - x[a]) * v, s = u(o, t, n);
            ...
            var h = 4, f = .001, p = 1e-7, g = 10, m = 11, v = 1 / (m - 1), b = "Float32Array" in e;
            ...
            var x = b ? new Float32Array(m) : new Array(m), w = !1, k = function (e)
            {
                return w || c(), t === i && n === a ? e : 0 === e ? 0 : 1 === e ? 1 : l(d(e), i, a)
            };
        ...
        function l(t)
        {
            if (t)
            {
                ...
                for (var a = 0; i > a; a++)
                {
                    if (b.State.calls[a])
                    {
                        var o = b.State.calls[a], s = o[0], c = o[2], h = o[3], f = !!h, g = null;
                        h || (h = b.State.calls[a][3] = e - 16);
                        for (var m = Math.min((e - h) / c.duration, 1), v = 0, y = s.length; y > v; v++)
                        {
                            var w = s[v], S = w.element;
                            if (r(S))
                            {
                                var C = !1;
                                ...
                                for (var M in w)
                                {
                                    if ("element" !== M)
                                    {
                                        var P, A = w[M], I = p.isString(A.easing) ? b.Easings[A.easing] : A.easing;
                                        if (1 === m)
                                        {
                                            P = A.endValue;
                                        }
                                        else
                                        {
                                            ...
                                            if (P = A.startValue + T * I(m, c, T), !f && P === A.currentValue)
                                            {
                                                continue
                                            }
                                        }
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                var D = x.Hooks.getRoot(M), F = r(S).rootPropertyValueCache[D];
                        ...
                        c.display !== n && "none" !== c.display && (b.State.calls[a][2].display = !1), c.visibility !== n && "hidden" !== c.visibility && (b.State.calls[a][2].visibility = !1), c.progress && c.progress.call(o[1], o[1], m, Math.max(0, h + c.duration - e), h, g), 1 === m && u(a)
                    }
                }
            }
        ...
        function u(t, e)
        {
            ...
            {
                var h = i[u].element;
                if (e || o.loop || ("none" === o.display && x.setPropertyValue(h, "display", o.display), "hidden" === o.visibility && x.setPropertyValue(h, "visibility", o.visibility)), !0 !== o.loop && (d.queue(h)[1] === n || !/\.velocityQueueEntryFlag/i.test(d.queue(h)[1])) && r(h))
                {
        ...
        }(), f = (c = 0, e.webkitRequestAnimationFrame || e.mozRequestAnimationFrame || function (t)
        {
            ...
            return e = Math.max(0, 16 - (i - c)), c = i + e, setTimeout(function ()
            {
                t(i + e)
            }, e)
        }), p = {
        ...
        if (t.fn && t.fn.jquery ? (d = t, g = !0) : d = e.Velocity.Utilities, 8 >= h && !g)
        {
        ...
        if (!(7 >= h))
        {
            ...
            var y = function ()
            {
                ...
                {
                    var o, s, l, u, d, c, h, f, p, g, m, v = {
                        x: -1,
                        v: 0,
                        tension: null,
                        friction: null
                    }, b = [0], y = 0;
                    for (n = parseFloat(n) || 500, a = parseFloat(a) || 20, r = r || null, v.tension = n, v.friction = a, (o = null !== r) ? s = (y = i(n, a)) / r * .016 : s = .016; d = s, void 0, void 0, void 0, void 0, void 0, void 0, c = {
                        dx: (u = l || v).v,
                        dv: t(u)
                    }, h = e(u, .5 * d, c), f = e(u, .5 * d, h), p = e(u, d, f), g = 1 / 6 * (c.dx + 2 * (h.dx + f.dx) + p.dx), m = 1 / 6 * (c.dv + 2 * (h.dv + f.dv) + p.dv), u.x = u.x + g * d, u.v = u.v + m * d, l = u, b.push(1 + l.x), y += 16, Math.abs(l.x) > 1e-4 && Math.abs(l.v) > 1e-4;)
                    {
                        ;
                    }
                    return o ? function (t)
            ...
            var x = b.CSS = {
                ...
                Hooks: {
                    ...
                    register: function ()
                    {
                        for (var t = 0; t < x.Lists.colors.length; t++)
                        {
                            ...
                            x.Hooks.templates[x.Lists.colors[t]] = ["Red Green Blue Alpha",
                                e]
                        }
                        var i, n, a;
                        if (h)
                        {
                            for (i in x.Hooks.templates)
                            {
                                ...
                                "Color" === a[0] && (a.push(a.shift()), r.push(r.shift()), x.Hooks.templates[i] = [a.join(" "),
                                    r.join(" ")])
                            }
                        }
                        for (i in x.Hooks.templates)
                ...
                Names: {
                    ...
                    prefixCheck: function (t)
                    {
                        ...
                        {
                            return [b.State.prefixMatches[t],
                                !0];
                        }
                        for (var e = ["",
                            "Webkit",
                            ...
                            "O"], i = 0, n = e.length; n > i; i++)
                        {
                            ...
                            {
                                return b.State.prefixMatches[t] = a, [a,
                                    !0]
                            }
                        }
                        return [t,
                ...
                Values: {
                    hexToRgb: function (t)
                    {
                        ...
                        {
                            return e + e + i + i + n + n
                        }), (e = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t)) ? [parseInt(e[1], 16),
                            parseInt(e[2], 16),
                            parseInt(e[3], 16)] : [0,
                            0,
                            0]
                ...
                getPropertyValue: function (t, i, a, o)
                {
                    function s(t, i)
                    {
                        ...
                        else
                        {
                            ...
                            u = r(t) === n ? e.getComputedStyle(t, null) : r(t).computedStyle ? r(t).computedStyle : r(t).computedStyle = e.getComputedStyle(t, null), "borderColor" === i && (i = "borderTopColor"), ("" === (l = 9 === h && "filter" === i ? u.getPropertyValue(i) : u[i]) || null === l) && (l = t.style[i]), a()
                        }
                ...
                setPropertyValue: function (t, i, n, a, o)
                {
                    ...
                    {
                        x.Normalizations.registered[i]("inject", t, n), s = "transform", n = r(t).transformCache[i];
                    }
                    else
                    {
                        if (x.Hooks.registered[i])
                        ...
                        if (x.Normalizations.registered[i] && (n = x.Normalizations.registered[i]("inject", t, n), i = x.Normalizations.registered[i]("name", t)), s = x.Names.prefixCheck(i)[0], 8 >= h)
                        {
                            try
                            {
                                t.style[s] = n
                        ...
                        {
                            r(t) && r(t).isSVG && x.Names.SVGAttribute(i) ? t.setAttribute(i, n) : t.style[s] = n;
                        }
            ...
            var w = function ()
            {
                function t()
                {
                    return o ? P.promise || null : c
                }

                var o, c, h, f, g, v, y = arguments[0] && (arguments[0].p || d.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || p.isString(arguments[0].properties));
                if (p.isWrapped(this) ? (o = !1, h = 0, f = this, c = this) : (o = !0, h = 1, f = y ? arguments[0].elements || arguments[0].e : arguments[0]), f = a(f))
                {
                    y ? (g = arguments[0].properties || arguments[0].p, v = arguments[0].options || arguments[0].o) : (g = arguments[h], v = arguments[h + 1]);
                    var k = f.length, S = 0;
                    if (!/^(stop|finish)$/i.test(g) && !d.isPlainObject(v))
                    {
                        v = {};
                        for (var C = h + 1; C < arguments.length; C++)
                        {
                            p.isArray(arguments[C]) || !/^(fast|normal|slow)$/i.test(arguments[C]) && !/^\d/.test(arguments[C]) ? p.isString(arguments[C]) || p.isArray(arguments[C]) ? v.easing = arguments[C] : p.isFunction(arguments[C]) && (v.complete = arguments[C]) : v.duration = arguments[C]
                        }
                    }
                    var M, P = {
                        promise: null,
                    ...
                    })), g)
                    {
                        ...
                        default:
                            if (!d.isPlainObject(g) || p.isEmptyObject(g))
                            {
                                ...
                                {
                                    var I = (V = d.extend({}, v)).duration, T = V.delay || 0;
                    ...
                    if (d.each(f, function (t, a)
                        {
                            p.isNode(a) && function ()
                            {
                                function t(t)
                                {
                                    ...
                                    {
                                        var i = n, a = n, r = n;
                                        return p.isArray(t) ? (i = t[0], !p.isArray(t[1]) && /^[\d-]/.test(t[1]) || p.isFunction(t[1]) || x.RegEx.isHex.test(t[1]) ? r = t[1] : (p.isString(t[1]) && !x.RegEx.isHex.test(t[1]) || p.isArray(t[1])) && (a = e ? t[1] : s(t[1], u.duration), t[2] !== n && (r = t[2]))) : i = t, e || (a = a || u.easing), p.isFunction(i) && (i = i.call(o, S, k)), p.isFunction(r) && (r = r.call(o, S, k)), [i || 0,
                                            a,
                                            r]
                                    }
                                    ...
                                    function y()
                                    {
                                        ...
                                        }, n = t.position === _.lastPosition && t.myParent === _.lastParent, a = t.fontSize === _.lastFontSize;
                                        _.lastParent = t.myParent, _.lastPosition = t.position, _.lastFontSize = t.fontSize;
                                        var s = {};
                                        if (a && n)
                                        {
                                            s.emToPx = _.lastEmToPx, s.percentToPxWidth = _.lastPercentToPxWidth, s.percentToPxHeight = _.lastPercentToPxHeight;
                                        }
                                        else
                                        {
                                            var l = r(o).isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");
                                            b.init(l), t.myParent.appendChild(l), d.each(["overflow",
                                                "overflowX",
                                                "overflowY"], function (t, e)
                                            {
                                                b.CSS.setPropertyValue(l, e, "hidden")
                                            }), b.CSS.setPropertyValue(l, "position", t.position), b.CSS.setPropertyValue(l, "fontSize", t.fontSize), b.CSS.setPropertyValue(l, "boxSizing", "content-box"), d.each(["minWidth",
                                                "maxWidth",
                                                "width",
                                                "minHeight",
                                                "maxHeight",
                                    ...
                                    if ("scroll" === M)
                                    {
                                        var w, C, A, I = /^x$/i.test(u.axis) ? "Left" : "Top", T = parseFloat(u.offset) || 0;
                                        u.container ? p.isWrapped(u.container) || p.isNode(u.container) ? (u.container = u.container[0] || u.container, A = (w = u.container["scroll" + I]) + d(o).position()[I.toLowerCase()] + T) : u.container = null : (w = b.State.scrollAnchor[b.State["scrollProperty" + I]], C = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === I ? "Top" : "Left")]], A = d(o).offset()[I.toLowerCase()] + T), c = {
                                            scroll: {
                                                rootPropertyValue: !1,
                                                startValue: w,
                                                currentValue: w,
                                        ...
                                        r(o).tweensContainer && !0 === r(o).isAnimating && (D = r(o).tweensContainer), d.each(g, function (t, e)
                                        {
                                            if (RegExp("^" + x.Lists.colors.join("$|^") + "$").test(t))
                                            {
                                                ...
                                                if (x.RegEx.isHex.test(a))
                                                {
                                                    for (var s = ["Red",
                                                        "Green",
                                                        "Blue"], l = x.Values.hexToRgb(a), u = o ? x.Values.hexToRgb(o) : n, d = 0; d < s.length; d++)
                                                    {
                                                        var c = [l[d]];
                                                        r && c.push(r), u !== n && c.push(u[d]), g[t + s[d]] = c
                                                    }
                                                    delete g[t]
                                                }
                                            }
                                        ...
                                        for (var O in g)
                                        {
                                            ...
                                            if (r(o).isSVG || "tween" === B || !1 !== x.Names.prefixCheck(B)[1] || x.Normalizations.registered[B] !== n)
                                            {
                                                ...
                                                if (N = (H = m(O, N))[0], q = H[1], z = (H = m(O, z))[0].replace(/^([+-\/*])=/, function (t, e)
                                                    {
                                                        return Y = e, ""
                                                    }), j = H[1], N = parseFloat(N) || 0, z = parseFloat(z) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(O) ? (z /= 100, j = "em") : /^scale/.test(O) ? (z /= 100, j = "") : /(Red|Green|Blue)$/i.test(O) && (z = z / 100 * 255, j = "")), /[\/*]/.test(Y))
                                                {
                                                    j = q;
                                                }
                                                else if (q !== j && 0 !== N)
                                    ...
                                    c.element && (x.Values.addClass(o, "velocity-animating"), L.push(c), "" === u.queue && (r(o).tweensContainer = c, r(o).opts = u), r(o).isAnimating = !0, S === k - 1 ? (b.State.calls.push([L,
                                        f,
                                        u,
                                        null,
                                        P.resolver]), !1 === b.State.isTicking && (b.State.isTicking = !0, l())) : S++)
                                }

                                var a, o = this, u = d.extend({}, b.defaults, v), c = {};
            ...
            }), t.Velocity = b, t !== e && (t.fn.velocity = w, t.fn.velocity.defaults = b.defaults), d.each(["Down",
                "Up"], function (t, e)
            {
                b.Redirects["slide" + e] = function (t, i, a, r, o, s)
                {
                    var l = d.extend({}, i), u = l.begin, c = l.complete, h = {
                        height: "",
                        marginTop: "",
                        marginBottom: "",
                        paddingTop: "",
    ...
    return function t(e, i, n)
    {
        ...
        4: [function (t, e, i)
        {
            function n(t)
            {
                ...
                return s == o ? e = 0 : n == s ? e = (a - r) / l : a == s ? e = 2 + (r - n) / l : r == s && (e = 4 + (n - a) / l), (e = Math.min(60 * e, 360)) < 0 && (e += 360), i = (o + s) / 2, [e,
            ...
            function a(t)
            {
                ...
                return i = 0 == s ? 0 : l / s * 1e3 / 10, s == o ? e = 0 : n == s ? e = (a - r) / l : a == s ? e = 2 + (r - n) / l : r == s && (e = 4 + (n - a) / l), (e = Math.min(60 * e, 360)) < 0 && (e += 360), [e,
                    i,
                    s / 255 * 1e3 / 10]
            }
            ...
            function s(t)
            {
                ...
                return [100 * ((1 - i - (e = Math.min(1 - i, 1 - n, 1 - a))) / (1 - e) || 0),
                    100 * ((1 - n - e) / (1 - e) || 0),
                    100 * ((1 - a - e) / (1 - e) || 0),
                    100 * e]
            }
            ...
            function u(t)
            {
                ...
                return [100 * (.4124 * (e = e > .04045 ? Math.pow((e + .055) / 1.055, 2.4) : e / 12.92) + .3576 * (i = i > .04045 ? Math.pow((i + .055) / 1.055, 2.4) : i / 12.92) + .1805 * (n = n > .04045 ? Math.pow((n + .055) / 1.055, 2.4) : n / 12.92)),
            ...
            function d(t)
            {
                ...
                return n /= 100, a /= 108.883, i = (i /= 95.047) > .008856 ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116, [116 * (n = n > .008856 ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116) - 16,
                    500 * (i - n),
            ...
            function h(t)
            {
                var e = t[0] / 60, i = t[1] / 100, n = t[2] / 100, a = Math.floor(e) % 6, r = e - Math.floor(e), o = 255 * n * (1 - i), s = 255 * n * (1 - i * r), l = 255 * n * (1 - i * (1 - r));
                n *= 255;
                switch (a)
                {
                    case 0:
            ...
            function p(t)
            {
                ...
                return [255 * (1 - Math.min(1, e * (1 - a) + a)),
            ...
            function m(t)
            {
                ...
                return i = -.9689 * a + 1.8758 * r + .0415 * o, n = .0557 * a + -.204 * r + 1.057 * o, e = (e = 3.2406 * a + -1.5372 * r + -.4986 * o) > .0031308 ? 1.055 * Math.pow(e, 1 / 2.4) - .055 : e *= 12.92, i = i > .0031308 ? 1.055 * Math.pow(i, 1 / 2.4) - .055 : i *= 12.92, n = n > .0031308 ? 1.055 * Math.pow(n, 1 / 2.4) - .055 : n *= 12.92, [255 * (e = Math.min(Math.max(0, e), 1)),
            ...
            function v(t)
            {
                ...
                return i /= 100, n /= 108.883, e = (e /= 95.047) > .008856 ? Math.pow(e, 1 / 3) : 7.787 * e + 16 / 116, [116 * (i = i > .008856 ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116) - 16,
                    500 * (e - i),
            ...
            function y(t)
            {
                ...
                return r <= 8 ? a = (i = 100 * r / 903.3) / 100 * 7.787 + 16 / 116 : (i = 100 * Math.pow((r + 16) / 116, 3), a = Math.pow(i / 100, 1 / 3)), [e = e / 95.047 <= .008856 ? e = 95.047 * (o / 500 + a - 16 / 116) / 7.787 : 95.047 * Math.pow(o / 500 + a, 3),
                    i,
                    n = n / 108.883 <= .008859 ? n = 108.883 * (a - s / 200 - 16 / 116) / 7.787 : 108.883 * Math.pow(a - s / 200, 3)]
            }

            function x(t)
            {
                var e, i = t[0], n = t[1], a = t[2];
                return (e = 360 * Math.atan2(a, n) / 2 / Math.PI) < 0 && (e += 360), [i,
                    Math.sqrt(n * n + a * a),
                    e]
            }
        ...
        15: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                t.defaults.bar = {
                    ...
                    {
                        var a = this, r = a.chart, o = a.getMeta(), s = a.getDataset(), l = t.custom || {}, u = r.options.elements.rectangle;
                    ...
                    {
                        var n = this, a = t._model, r = n.getValueScale(), o = r.getBasePixel(), s = r.isHorizontal(), l = n._ruler || n.getRuler(), u = n.calculateBarValuePixels(n.index, e), d = n.calculateBarIndexPixels(n.index, e, l);
                    ...
                    getRuler: function ()
                    {
                        var t = this.getIndexScale(), i = t.options, n = this.getStackCount(), a = (t.isHorizontal() ? t.width : t.height) / t.ticks.length, r = a * i.categoryPercentage, o = r / n, s = o * i.barPercentage;
                        return {
                            stackCount: n,
                            tickSize: a,
                            categorySize: r,
                    ...
                    {
                        var i, n, a, r, o, s, l = this.chart, u = this.getMeta(), d = this.getValueScale(), c = l.data.datasets, h = Number(c[t].data[e]), f = d.options.stacked, p = u.stack, g = 0;
                        if (f || void 0 === f && void 0 !== p)
                        {
                            for (i = 0; i < t; ++i)
                            {
                                (n = l.getDatasetMeta(i)).bar && n.stack === p && n.controller.getValueScaleId() === d.id && l.isDatasetVisible(i) && (a = Number(c[i].data[e]), (h < 0 && a < 0 || h >= 0 && a > 0) && (g += a));
                            }
                        }
                    ...
                    {
                        var n = i.scale, a = this.chart.isCombo, r = this.getStackIndex(t), o = n.getPixelForValue(null, e, t, a), s = i.barSize;
                    ...
                    draw: function ()
                    {
                        var t, i = this.chart, n = this.getMeta().data, a = this.getDataset(), r = n.length, o = 0;
                        for (e.canvas.clipArea(i.ctx, i.chartArea); o < r; ++o)
                        {
                            null === (t = a.data[o]) || void 0 === t || isNaN(t) || n[o].draw();
                        }
                        e.canvas.unclipArea(i.ctx)
                    },
                    setHoverStyle: function (t)
                    {
                        var i = this.chart.data.datasets[t._datasetIndex], n = t._index, a = t.custom || {}, r = t._model;
                    ...
                    {
                        var i = this.chart.data.datasets[t._datasetIndex], n = t._index, a = t.custom || {}, r = t._model, o = this.chart.options.elements.rectangle;
        ...
        16: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                t.defaults.bubble = {
                    ...
                    {
                        var r = this, o = r.getMeta(), s = r.getScaleForId(o.xAxisID), l = r.getScaleForId(o.yAxisID), u = i.custom || {}, d = r.getDataset(), c = d.data[n], h = r.chart.options.elements.point, f = r.index;
                        e.extend(i, {
                            _xScale: s,
                            _yScale: l,
                            _datasetIndex: f,
                    ...
                    setHoverStyle: function (i)
                    {
                        ...
                        var n = this.chart.data.datasets[i._datasetIndex], a = i._index, r = i.custom || {};
                    ...
                    removeHoverStyle: function (e)
                    {
                        ...
                        var i = this.chart.data.datasets[e._datasetIndex].data[e._index], n = e.custom || {};
                ...
                i.doughnut = {
                    ...
                    legend: {
                        labels: {
                            generateLabels: function (t)
                            {
                                ...
                                {
                                    var r = t.getDatasetMeta(0), o = i.datasets[0], s = r.data[a], l = s && s.custom || {}, u = e.getValueAtIndexOrDefault, d = t.options.elements.arc;
                                    return {
                                        text: n,
                    ...
                    tooltips: {
                        callbacks: {
                            ...
                            label: function (t, i)
                            {
                                var n = i.labels[t.index], a = ": " + i.datasets[t.datasetIndex].data[t.index];
                    ...
                    update: function (t)
                    {
                        var i = this, n = i.chart, a = n.chartArea, r = n.options, o = r.elements.arc, s = a.right - a.left - o.borderWidth, l = a.bottom - a.top - o.borderWidth, u = Math.min(s, l), d = {
                            x: 0,
                            y: 0
                        }, c = i.getMeta(), h = r.cutoutPercentage, f = r.circumference;
                        if (f < 2 * Math.PI)
                        {
                            var p = r.rotation % (2 * Math.PI), g = (p += 2 * Math.PI * (p >= Math.PI ? -1 : p < -Math.PI ? 1 : 0)) + f, m = {
                                x: Math.cos(p),
                                y: Math.sin(p)
                            }, v = {
                                x: Math.cos(g),
                                y: Math.sin(g)
                            }, b = p <= 0 && 0 <= g || p <= 2 * Math.PI && 2 * Math.PI <= g, y = p <= .5 * Math.PI && .5 * Math.PI <= g || p <= 2.5 * Math.PI && 2.5 * Math.PI <= g, x = p <= -Math.PI && -Math.PI <= g || p <= Math.PI && Math.PI <= g, w = p <= .5 * -Math.PI && .5 * -Math.PI <= g || p <= 1.5 * Math.PI && 1.5 * Math.PI <= g, k = h / 100, S = {
        ...
        18: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                t.defaults.line = {
                    ...
                    update: function (t)
                    {
                        var n, a, r, o = this, s = o.getMeta(), l = s.dataset, u = s.data || [], d = o.chart.options, c = d.elements.line, h = o.getScaleForId(s.yAxisID), f = o.getDataset(), p = i(f, d);
                        ...
                        }, l.pivot()), n = 0, a = u.length; n < a; ++n)
                        {
                            o.updateElement(u[n], n, t);
                        }
                        for (p && 0 !== l._model.tension && o.updateBezierControlPoints(), n = 0, a = u.length; n < a; ++n)
                        {
                            u[n].pivot()
                        }
                    },
                    ...
                    {
                        var n = this.chart.options.elements.point.backgroundColor, a = this.getDataset(), r = t.custom || {};
                    ...
                    {
                        var n = this.chart.options.elements.point.borderColor, a = this.getDataset(), r = t.custom || {};
                    ...
                    {
                        var n = this.chart.options.elements.point.borderWidth, a = this.getDataset(), r = t.custom || {};
                    ...
                    updateElement: function (t, i, n)
                    {
                        var a, r, o = this, s = o.getMeta(), l = t.custom || {}, u = o.getDataset(), d = o.index, c = u.data[i], h = o.getScaleForId(s.yAxisID), f = o.getScaleForId(s.xAxisID), p = o.chart.options.elements.point, g = 1 === (o.chart.data.labels || []).length || 1 === u.data.length || o.chart.isCombo;
                    ...
                    {
                        var t, i, n, a, r = this.getMeta(), o = this.chart.chartArea, s = r.data || [];
                        ...
                        else
                        {
                            ...
                            {
                                n = s[t]._model, a = e.splineCurve(e.previousItem(s, t)._model, n, e.nextItem(s, t)._model, r.dataset._model.tension), n.controlPointPreviousX = a.previous.x, n.controlPointPreviousY = a.previous.y, n.controlPointNextX = a.next.x, n.controlPointNextY = a.next.y;
                            }
                        }
                    ...
                    draw: function ()
                    {
                        var e = this.chart, n = this.getMeta(), a = n.data || [], r = e.chartArea, o = a.length, s = 0;
                        for (t.canvasHelpers.clipArea(e.ctx, r), i(this.getDataset(), e.options) && n.dataset.draw(), t.canvasHelpers.unclipArea(e.ctx); s < o; ++s)
                        {
                            a[s].draw(r)
                        }
                    },
                    ...
                    removeHoverStyle: function (t)
                    {
                        var i = this, n = i.chart.data.datasets[t._datasetIndex], a = t._index, r = t.custom || {}, o = t._model;
        ...
        19: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                t.defaults.polarArea = {
                    ...
                    legend: {
                        labels: {
                            generateLabels: function (t)
                            {
                                ...
                                return i.labels.length && i.datasets.length ? i.labels.map(function (n, a)
                                {
                                    var r = t.getDatasetMeta(0), o = i.datasets[0], s = r.data[a].custom || {}, l = e.getValueAtIndexOrDefault, u = t.options.elements.arc;
                                    return {
                                        text: n,
                    ...
                    update: function (t)
                    {
                        var i = this, n = i.chart, a = n.chartArea, r = i.getMeta(), o = n.options, s = o.elements.arc, l = Math.min(a.right - a.left, a.bottom - a.top);
                    ...
                    updateElement: function (t, i, n)
                    {
                        for (var a = this, r = a.chart, o = a.getDataset(), s = r.options, l = s.animation, u = r.scale, d = e.getValueAtIndexOrDefault, c = r.data.labels, h = a.calculateCircumference(o.data[i]), f = u.xCenter, p = u.yCenter, g = 0, m = a.getMeta(), v = 0; v < i; ++v)
                        {
                            isNaN(o.data[v]) || m.data[v].hidden || ++g;
                        }
                        var b = s.startAngle, y = t.hidden ? 0 : u.getDistanceFromCenterForValue(o.data[i]), x = b + h * g, w = x + (t.hidden ? 0 : h), k = l.animateScale ? 0 : u.getDistanceFromCenterForValue(o.data[i]);
                        e.extend(t, {
                            _datasetIndex: a.index,
                            _index: i,
                            _scale: u,
        ...
        20: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                t.defaults.radar = {
                    ...
                    update: function (t)
                    {
                        var i = this, n = i.getMeta(), a = n.dataset, r = n.data, o = a.custom || {}, s = i.getDataset(), l = i.chart.options.elements.line, u = i.chart.scale;
                    ...
                    updateElement: function (t, i, n)
                    {
                        var a = this, r = t.custom || {}, o = a.getDataset(), s = a.chart.scale, l = a.chart.options.elements.point, u = s.getPointPositionForValue(i, o.data[i]);
                    ...
                    updateBezierControlPoints: function ()
                    {
                        ...
                        {
                            var r = n._model, o = e.splineCurve(e.previousItem(i.data, a, !0)._model, r, e.nextItem(i.data, a, !0)._model, r.tension);
                    ...
                    setHoverStyle: function (t)
                    {
                        var i = this.chart.data.datasets[t._datasetIndex], n = t.custom || {}, a = t._index, r = t._model;
                    ...
                    removeHoverStyle: function (t)
                    {
                        var i = this.chart.data.datasets[t._datasetIndex], n = t.custom || {}, a = t._index, r = t._model, o = this.chart.options.elements.point;
            ...
            e.exports = function (t)
            {
                ...
                t.defaults.global.animation = {
                    ...
                    advance: function (t)
                    {
                        ...
                        {
                            n = (i = a[r]).chart, i.currentStep = (i.currentStep || 0) + t, i.currentStep = Math.min(i.currentStep, i.numSteps), e.callback(i.render, [n,
                                i], n), e.callback(i.onAnimationProgress, [i], n), i.currentStep >= i.numSteps ? (e.callback(i.onAnimationComplete, [i], n), n.animating = !1, a.splice(r, 1)) : ++r
                        }
                    }
        ...
        22: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                e.drawPoint = function (e, i, n, a, r)
                {
                        ...
                        if (!(isNaN(n) || n <= 0))
                        {
                            switch (i)
                            {
                                ...
                                case"rect":
                                    ...
                                    break;
                                case"rectRounded":
                                    var h = n / Math.SQRT2, f = a - h, p = r - h, g = Math.SQRT2 * n;
                    ...
                    {
                        e.drawImage(i, a - i.width / 2, r - i.height / 2, i.width, i.height)
                    }
                ...
                }, e.lineTo = function (t, e, i, n)
                {
                    if (i.steppedLine)
                    {
                        return "after" === i.steppedLine ? t.lineTo(e.x, i.y) : t.lineTo(i.x, e.y), void t.lineTo(i.x, i.y);
                    }
        ...
        23: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                var e = t.helpers, i = t.plugins, n = t.platform;
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, e.extend(t.prototype, {
                    construct: function (i, a)
                    {
                        ...
                        var l = n.acquireContext(i, a), u = l && l.canvas, d = u && u.height, c = u && u.width;
                        s.id = e.uid(), s.ctx = l, s.canvas = u, s.config = a, s.width = c, s.height = d, s.aspectRatio = d ? c / d : null, s.options = a.options, s._bufferedRender = !1, s.chart = s, s.controller = s, t.instances[s.id] = s, Object.defineProperty(s, "data", {
                            get: function ()
                            {
                    ...
                    resize: function (t)
                    {
                        var n = this, a = n.options, r = n.canvas, o = a.maintainAspectRatio && n.aspectRatio || null, s = Math.floor(e.getMaximumWidth(r)), l = Math.floor(o ? s / o : e.getMaximumHeight(r));
                    ...
                    buildScales: function ()
                    {
                        ...
                        {
                            var o = n.options, s = e.getValueOrDefault(o.type, n.dtype), l = t.scaleService.getScaleConstructor(s);
                            if (l)
                            {
                        ...
                        if (e.each(i.data.datasets, function (e, r)
                            {
                                ...
                                if (o.type || (o.type = e.type || i.config.type), n.push(o.type), o.controller)
                                {
                    ...
                    render: function (n, a)
                    {
                        ...
                        {
                            var o = r.options.animation, s = function (t)
                            {
                            ...
                            if (o && (void 0 !== n && 0 !== n || void 0 === n && 0 !== o.duration))
                            {
                                var l = new t.Animation({
                                    ...
                                    render: function (t, i)
                                    {
                                        var n = e.easingEffects[i.easing], a = i.currentStep, r = a / i.numSteps;
                                        t.draw(n(r), r, a)
                                    },
                    ...
                    destroy: function ()
                    {
                        var a, r, o, s = this, l = s.canvas;
                        for (s.stop(), r = 0, o = s.data.datasets.length; r < o; ++r)
                        {
                            (a = s.getDatasetMeta(r)).controller && (a.controller.destroy(), a.controller = null);
                        }
                    ...
                    bindEvents: function ()
                    {
                        var t = this, i = t._listeners = {}, a = function ()
                        {
                    ...
                    {
                        var i, n = this, a = n.options || {}, r = a.hover;
        ...
        24: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                function n(t, e)
                {
                    ...
                    if (n)
                    {
                        var a = n.listeners, r = a.indexOf(e);
                ...
                t.DatasetController = function (t, e)
                {
                    ...
                    buildOrUpdateElements: function ()
                    {
                        ...
                        {
                            var n = "onData" + i.charAt(0).toUpperCase() + i.slice(1), a = t[i];
                            Object.defineProperty(t, i, {
                                configurable: !0,
                                enumerable: !1,
                                value: function ()
                                {
                                    var i = Array.prototype.slice.call(arguments), r = a.apply(this, i);
                    ...
                    {
                        var n = this.chart.data.datasets[t._datasetIndex], a = t._index, r = t.custom || {}, o = e.getValueAtIndexOrDefault, s = t._model;
                    ...
                    setHoverStyle: function (t)
                    {
                        var i = this.chart.data.datasets[t._datasetIndex], n = t._index, a = t.custom || {}, r = e.getValueAtIndexOrDefault, o = e.getHoverColor, s = t._model;
            ...
            e.exports = function (t)
            {
                ...
                }, i.configMerge = function (e)
                {
                    ...
                    return i.each(Array.prototype.slice.call(arguments, 1), function (e)
                    {
                        ...
                        {
                            var r = n.hasOwnProperty(a), o = r ? n[a] : {};
                ...
                }, i.scaleMerge = function (e, n)
                {
                    ...
                    return i.each(n, function (e, n)
                    {
                        ...
                        {
                            var o = i.getValueOrDefault(e.type, "xAxes" === n ? "category" : "linear"), s = t.scaleService.getScaleDefaults(o);
                ...
                {
                    var a = t.skip ? e : t, r = e, o = i.skip ? e : i, s = Math.sqrt(Math.pow(r.x - a.x, 2) + Math.pow(r.y - a.y, 2)), l = Math.sqrt(Math.pow(o.x - r.x, 2) + Math.pow(o.y - r.y, 2)), u = s / (s + l), d = l / (s + l), c = n * (u = isNaN(u) ? 0 : u), h = n * (d = isNaN(d) ? 0 : d);
                    return {
                        previous: {
                            x: r.x - c * (o.x - a.x),
                            y: r.y - c * (o.y - a.y)
                ...
                }, i.EPSILON = Number.EPSILON || 1e-14, i.splineCurveMonotone = function (t)
                {
                    ...
                    for (e = 0; e < h - 1; ++e)
                    {
                        a = c[e], r = c[e + 1], a.model.skip || r.model.skip || (i.almostEquals(a.deltaK, 0, this.EPSILON) ? a.mK = r.mK = 0 : (o = a.mK / a.deltaK, s = r.mK / a.deltaK, (u = Math.pow(o, 2) + Math.pow(s, 2)) <= 9 || (l = 3 / Math.sqrt(u), a.mK = o * l * a.deltaK, r.mK = s * l * a.deltaK)));
                    }
                    for (e = 0; e < h; ++e)
                    {
                        (a = c[e]).model.skip || (n = e > 0 ? c[e - 1] : null, r = e < h - 1 ? c[e + 1] : null, n && !n.model.skip && (d = (a.model.x - n.model.x) / 3, a.model.controlPointPreviousX = a.model.x - d, a.model.controlPointPreviousY = a.model.y - d * a.mK), r && !r.model.skip && (d = (r.model.x - a.model.x) / 3, a.model.controlPointNextX = a.model.x + d, a.model.controlPointNextY = a.model.y + d * a.mK))
                    }
                ...
                {
                    var n = Math.floor(i.log10(t)), a = t / Math.pow(10, n);
                ...
                function s(t, e, i)
                {
                    var n = document.defaultView, a = t.parentNode, s = n.getComputedStyle(t)[e], l = n.getComputedStyle(a)[e], u = o(s), d = o(l), c = Number.POSITIVE_INFINITY;
                ...
                {
                    var n, a, r = t.originalEvent || t, o = t.currentTarget || t.srcElement, s = o.getBoundingClientRect(), l = r.touches;
                    l && l.length > 0 ? (n = l[0].clientX, a = l[0].clientY) : (n = r.clientX, a = r.clientY);
                    var u = parseFloat(i.getStyle(o, "padding-left")), d = parseFloat(i.getStyle(o, "padding-top")), c = parseFloat(i.getStyle(o, "padding-right")), h = parseFloat(i.getStyle(o, "padding-bottom")), f = s.right - s.left - u - c, p = s.bottom - s.top - d - h;
                    return {
                ...
                {
                    var e = t.parentNode, n = parseInt(i.getStyle(e, "padding-left"), 10), a = parseInt(i.getStyle(e, "padding-right"), 10), r = e.clientWidth - n - a, o = i.getConstraintWidth(t);
                    return isNaN(o) ? r : Math.min(r, o)
                }, i.getMaximumHeight = function (t)
                {
                    var e = t.parentNode, n = parseInt(i.getStyle(e, "padding-top"), 10), a = parseInt(i.getStyle(e, "padding-bottom"), 10), r = e.clientHeight - n - a, o = i.getConstraintHeight(t);
                    return isNaN(o) ? r : Math.min(r, o)
                ...
                }, i.retinaScale = function (t)
                {
                    ...
                    if (1 !== e)
                    {
                        var i = t.canvas, n = t.height, a = t.width;
                ...
                {
                    var r = (a = a || {}).data = a.data || {}, o = a.garbageCollect = a.garbageCollect || [];
        ...
        27: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                function o(t, e, n)
                {
                    var o = i(e, t), s = n.intersect ? a(t, o) : r(t, o, !1, function (t, e)
                    {
                ...
                t.Interaction = {
                    modes: {
                        ...
                        {
                            var o = i(e, t), s = n.intersect ? a(t, o) : r(t, o, !1);
        ...
        29: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                t.layoutService = {
                    ...
                    {
                        for (var n, a = ["fullWidth",
                            "position",
                            "weight"], r = a.length, o = 0; o < r; ++o)
                        {
                    ...
                    update: function (t, a, r)
                    {
                        if (t)
                        {
                            var o = t.options.layout, s = o ? o.padding : null, l = 0, u = 0, d = 0, c = 0;
                            isNaN(s) ? (l = s.left || 0, u = s.right || 0, d = s.top || 0, c = s.bottom || 0) : (l = s, u = s, d = s, c = s);
                            var h = i(t.boxes, "left"), f = i(t.boxes, "right"), p = i(t.boxes, "top"), g = i(t.boxes, "bottom"), m = i(t.boxes, "chartArea");
                            n(h, !0), n(f, !1), n(p, !0), n(g, !1);
                            var v = a - l - u, b = r - d - c, y = b / 2, x = (a - v / 2) / (h.length + f.length), w = (r - y) / (p.length + g.length), k = v, S = b, C = [];
            ...
            e.exports = function (t)
            {
                ...
                t.defaults.global.plugins = {}, t.plugins = {
                    ...
                    descriptors: function (i)
                    {
                        ...
                        if (n.id === this._cacheId)
                        {
                            return n.descriptors;
                        }
                        var a = [], r = [], o = i && i.config || {}, s = t.defaults.global.plugins, l = o.options && o.options.plugins || {};
        ...
        31: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                function n(i)
                {
                    var n = e.getValueOrDefault, a = t.defaults.global, r = n(i.fontSize, a.defaultFontSize), o = n(i.fontStyle, a.defaultFontStyle), s = n(i.fontFamily, a.defaultFontFamily);
                    return {
                        size: r,
                        style: o,
                        family: s,
                ...
                t.defaults.scale = {
                    ...
                    {
                        var t = this, i = t.ctx, a = t.options.ticks, r = n(a);
                        i.font = r.font;
                    ...
                    fit: function ()
                    {
                        var t = this, a = t.minSize = {
                            width: 0,
                            height: 0
                        }, r = t.options, o = r.ticks, s = r.scaleLabel, l = r.gridLines, u = r.display, d = t.isHorizontal(), c = n(o), h = 1.5 * n(s).size, f = r.gridLines.tickMarkLength;
                        ...
                        {
                            var p = e.longestText(t.ctx, c.font, t.ticks, t.longestTextCache), g = e.numberOfLabelLines(t.ticks), m = .5 * c.size;
                            if (d)
                            {
                                t.longestLabelWidth = p;
                                var v = e.toRadians(t.labelRotation), b = Math.cos(v), y = Math.sin(v) * p + c.size * g + m * g;
                                a.height = Math.min(t.maxHeight, a.height + y), t.ctx.font = c.font;
                                var x = t.ticks[0], w = i(t.ctx, x, c.font), k = t.ticks[t.ticks.length - 1], S = i(t.ctx, k, c.font);
                            ...
                            {
                                o.mirror ? p = 0 : p += t.options.ticks.padding, a.width = Math.min(t.maxWidth, a.width + p), t.paddingTop = c.size / 2, t.paddingBottom = c.size / 2
                            }
                        }
                    ...
                    getPixelForTick: function (t, e)
                    {
                        ...
                        if (i.isHorizontal())
                        {
                            var n = (i.width - (i.paddingLeft + i.paddingRight)) / Math.max(i.ticks.length - (i.options.gridLines.offsetGridLines ? 0 : 1), 1), a = n * t + i.paddingLeft;
                            e && (a += n / 2);
                    ...
                    draw: function (i)
                    {
                        ...
                        if (r.display)
                        {
                            var o, s, l = a.ctx, u = t.defaults.global, d = r.ticks, c = r.gridLines, h = r.scaleLabel, f = 0 !== a.labelRotation, p = d.autoSkip, g = a.isHorizontal();
                            d.maxTicksLimit && (s = d.maxTicksLimit);
                            var m = e.getValueOrDefault(d.fontColor, u.defaultFontColor), v = n(d), b = c.drawTicks ? c.tickMarkLength : 0, y = e.getValueOrDefault(h.fontColor, u.defaultFontColor), x = n(h), w = e.toRadians(a.labelRotation), k = Math.cos(w), S = a.longestLabelWidth * k;
                            l.fillStyle = m;
                            var C = [];
                            if (g)
                            {
                            ...
                            var M = "right" === r.position ? a.left : a.right - b, P = "right" === r.position ? a.left + b : a.right, A = "bottom" === r.position ? a.top : a.bottom - b, I = "bottom" === r.position ? a.top + b : a.bottom;
                            if (e.each(a.ticks, function (t, n)
                                {
                                    if (void 0 !== t && null !== t)
                                    {
                                        ...
                                        if ((!(o > 1 && n % o > 0 || n % o == 0 && n + o >= a.ticks.length) || s) && void 0 !== t && null !== t)
                                        {
                                            ...
                                            {
                                                var z, E = "left" === r.position, N = d.padding;
                                ...
                                }), h.display)
                            {
                                ...
                                if (g)
                                {
                                    T = a.left + (a.right - a.left) / 2, D = "bottom" === r.position ? a.bottom - x.size / 2 : a.top + x.size / 2;
                                }
                                else
                                {
                            ...
                            if (c.drawBorder)
                            {
                                ...
                                var _ = a.left, L = a.right, O = a.top, R = a.bottom, z = e.aliasPixel(l.lineWidth);
                ...
                t.Ticks = {
                    generators: {
                        linear: function (t, i)
                        {
                            ...
                            var o = Math.floor(i.min / n) * n, s = Math.ceil(i.max / n) * n;
                        ...
                        {
                            var n, a, r = [], o = e.getValueOrDefault, s = o(t.min, Math.pow(10, Math.floor(e.log10(i.min)))), l = Math.floor(e.log10(i.max)), u = Math.ceil(i.max / Math.pow(10, l));
        ...
        34: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                function a(i)
                {
                    var n = t.defaults.global, a = e.getValueOrDefault;
                    return {
                        xPadding: i.xPadding,
                        yPadding: i.yPadding,
                        xAlign: i.xAlign,
                ...
                t.defaults.global.tooltips = {
                    ...
                    getTitle: function ()
                    {
                        var t = this._options.callbacks, e = t.beforeTitle.apply(this, arguments), i = t.title.apply(this, arguments), a = t.afterTitle.apply(this, arguments), r = [];
                    ...
                    {
                        var a = this, r = a._options.callbacks, o = [];
                    ...
                    getFooter: function ()
                    {
                        var t = this._options.callbacks, e = t.beforeFooter.apply(this, arguments), i = t.footer.apply(this, arguments), a = t.afterFooter.apply(this, arguments), r = [];
                        return r = n(r = n(r = n(r, e), i), a)
                    },
                    update: function (i)
                    {
                        var n, r, o, s, l, u, d, c, h, f, p, g, m, v, b, y, x, w, k, S = this, C = S._options, M = S._model, P = S._model = a(C), A = S._active, I = S._data, T = {
                            xAlign: M.xAlign,
                            yAlign: M.yAlign
                        }, D = {
                            x: M.x,
                        ...
                        if (A.length)
                        {
                            ...
                            {
                                var n = t._chart.ctx, a = 2 * i.yPadding, r = 0, o = i.body, s = o.reduce(function (t, e)
                                {
                                    return t + e.before.length + e.lines.length + e.after.length
                                }, 0);
                                s += i.beforeBody.length + i.afterBody.length;
                                var l = i.title.length, u = i.footer.length, d = i.titleFontSize, c = i.bodyFontSize, h = i.footerFontSize;
                            ...
                            }(this, P)), s = F, l = T, u = (o = P).x, d = o.y, c = o.caretSize, h = o.caretPadding, f = o.cornerRadius, p = l.xAlign, g = l.yAlign, m = c + h, v = f + h, "right" === p ? u -= s.width : "center" === p && (u -= s.width / 2), "top" === g ? d += m : d -= "bottom" === g ? s.height + m : s.height / 2, "center" === g ? "left" === p ? u += m : "right" === p && (u -= m) : "left" === p ? u -= v : "right" === p && (u += v), D = {
                                x: u,
                                y: d
                            }
                        }
                    ...
                    {
                        var n, a, r, o, s, l, u = i.caretSize, d = i.cornerRadius, c = i.xAlign, h = i.yAlign, f = t.x, p = t.y, g = e.width, m = e.height;
                        if ("center" === h)
                        {
                            s = p + m / 2, "left" === c ? (a = (n = f) - u, r = n, o = s + u, l = s - u) : (a = (n = f + g) + u, r = n, o = s - u, l = s + u);
                        }
                        else if ("left" === c ? (n = (a = f + d + u) - u, r = a + u) : "right" === c ? (n = (a = f + g - d - u) - u, r = a + u) : (n = (a = f + g / 2) - u, r = a + u), "top" === h)
                        {
                            s = (o = p) - u, l = o;
                        }
                        else
                    ...
                    drawTitle: function (t, n, a, r)
                    {
                        ...
                        if (o.length)
                        {
                            ...
                            var s, l, u = n.titleFontSize, d = n.titleSpacing;
                            for (a.fillStyle = i(n.titleFontColor, r), a.font = e.fontString(u, n._titleFontStyle, n._titleFontFamily), s = 0, l = o.length; s < l; ++s)
                            {
                                a.fillText(o[s], t.x, t.y), t.y += u + d, s + 1 === o.length && (t.y += n.titleMarginBottom - d)
                            }
                        }
                    },
                    ...
                    drawBackground: function (t, e, n, a, r)
                    {
                        ...
                        var o = e.xAlign, s = e.yAlign, l = t.x, u = t.y, d = a.width, c = a.height, h = e.cornerRadius;
                    ...
                    handleEvent: function (t)
                    {
                        var i = this, n = i._options, a = !1;
                        if (i._lastActive = i._lastActive || [], "mouseout" === t.type ? i._active = [] : i._active = i._chart.getElementsAtEventForMode(t, n.mode, n), !(a = !e.arrayEquals(i._active, i._lastActive)))
                        {
                            return !1;
                        }
                    ...
                    {
                        var n, a, r, o = i.x, s = i.y, l = Number.POSITIVE_INFINITY;
                        for (a = 0, r = t.length; a < r; ++a)
                        {
                            var u = t[a];
                            if (u && u.hasValue())
                            {
                                var d = u.getCenterPoint(), c = e.distanceBetweenPoints(i, d);
                                c < l && (l = c, n = u)
                            }
                        }
                        if (n)
                    ...
                    inRange: function (t, i)
                    {
                        ...
                        if (n)
                        {
                            for (var a = e.getAngleFromPoint(n, {
                                x: t,
                                y: i
                            }), r = a.angle, o = a.distance, s = n.startAngle, l = n.endAngle; l < s;)
                            {
                                l += 2 * Math.PI;
                            }
                            for (; r > l;)
                            ...
                            var u = r >= s && r <= l, d = o >= n.innerRadius && o <= n.outerRadius;
                            return u && d
                        }
                        return !1
                    },
        ...
        36: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                t.defaults.global.elements.line = {
                    ...
                    draw: function ()
                    {
                        var t, n, a, r, o = this._view, s = this._chart.ctx, l = o.spanGaps, u = this._children.slice(), d = i.elements.line, c = -1;
                        for (this._loop && u.length && u.push(u[0]), s.save(), s.lineCap = o.borderCapStyle || d.borderCapStyle, s.setLineDash && s.setLineDash(o.borderDash || d.borderDash), s.lineDashOffset = o.borderDashOffset || d.borderDashOffset, s.lineJoin = o.borderJoinStyle || d.borderJoinStyle, s.lineWidth = o.borderWidth || d.borderWidth, s.strokeStyle = o.borderColor || i.defaultColor, s.beginPath(), c = -1, t = 0; t < u.length; ++t)
                        {
                            n = u[t], a = e.previousItem(u, t), r = n._view, 0 === t ? r.skip || (s.moveTo(r.x, r.y), c = t) : (a = -1 === c ? a : u[c], r.skip || (c !== t - 1 && !l || -1 === c ? s.moveTo(r.x, r.y) : e.canvas.lineTo(s, a._view, n._view), c = t));
                        }
                        s.stroke(), s.restore()
                    }
                })
        ...
        37: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                i.elements.point = {
                    ...
                    draw: function (a)
                    {
                        var r = this._view, o = this._model, s = this._chart.ctx, l = r.pointStyle, u = r.radius, d = r.x, c = r.y, h = t.helpers.color, f = 0;
            ...
            e.exports = function (t)
            {
                ...
                e.elements.rectangle = {
                    ...
                    draw: function ()
                    {
                        ...
                        {
                            var d = Math.min(Math.abs(t - e), Math.abs(i - n)), c = (u = u > d ? d : u) / 2, h = t + ("left" !== o ? c * a : 0), f = e + ("right" !== o ? -c * a : 0), p = i + ("top" !== o ? c * r : 0), g = n + ("bottom" !== o ? -c * r : 0);
        ...
        39: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                function n(t, i)
                {
                    var n = e.getStyle(t, i), a = n && n.match(/^(\d+)(\.\d+)?px$/);
                ...
                function r(t, i, n)
                {
                    var r, o, s = t._chartjs = {ticking: !1};
                    s.resizer = (r = function ()
                    {
                        s.ticking || (s.ticking = !0, e.requestAnimFrame.call(window, function ()
                        {
                            if (s.resizer)
                            {
                                return s.ticking = !1, i(a("resize", n))
                            }
                        }))
                ...
                return {
                    ...
                    addEventListener: function (t, n, o)
                    {
                        ...
                        if ("resize" !== n)
                        {
                            var l = o._chartjs || (o._chartjs = {}), u = (l.proxies || (l.proxies = {}))[t.id + "_" + n] = function (n)
                            {
                                var r, s, l, u;
        ...
        41: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                var e = t.defaults, i = t.helpers, n = {
                    dataset: function (t)
                    {
                        var e = t.fill, i = t.chart, n = i.getDatasetMeta(e), a = n && i.isDatasetVisible(e) && n.dataset._children || [];
                ...
                return {
                    ...
                    {
                        var s, l, u, d, c, h, f, p = (e.data.datasets || []).length, g = i.propagate, m = [];
                        for (l = 0; l < p; ++l)
                        {
                        ...
                        for (l = 0; l < p; ++l)
                        {
                            (d = m[l]) && (d.fill = o(m, l, g), d.boundary = r(d), d.mapper = (void 0, f = void 0, h = (c = d).fill, f = "dataset", !1 === h ? null : (isFinite(h) || (f = "boundary"), n[f](c))))
                        }
                    },
                    beforeDatasetDraw: function (t, i)
                    {
                        ...
                        if (n)
                        {
                            var a = n.el, r = a._view, o = a._children || [], u = n.mapper, d = r.backgroundColor || e.global.defaultColor;
                            u && d && o.length && function (t, e, i, n, a, r)
                            {
                                var o, u, d, c, h, f, p, g = e.length, m = n.spanGaps, v = [], b = [], y = 0, x = 0;
                                for (t.beginPath(), o = 0, u = g + !!r; o < u; ++o)
                                {
                                    h = i(c = e[d = o % g]._view, d, n), f = s(c), p = s(h), f && p ? (y = v.push(c), x = b.push(h)) : y && x && (m ? (f && v.push(c), p && b.push(h)) : (l(t, v, b, y, x), y = x = 0, v = [], b = []));
                                }
        ...
        42: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                var e = t.helpers, i = t.layoutService, n = e.noop;
                ...
                return t.defaults.global.legend = {
                    ...
                    {
                        var t = this, e = t.options.labels, i = e.generateLabels.call(t, t.chart);
                    ...
                    fit: function ()
                    {
                        var i = this, n = i.options, r = n.labels, o = n.display, s = i.ctx, l = t.defaults.global, u = e.getValueOrDefault, d = u(r.fontSize, l.defaultFontSize), c = u(r.fontStyle, l.defaultFontStyle), h = u(r.fontFamily, l.defaultFontFamily), f = e.fontString(d, c, h), p = i.legendHitBoxes = [], g = i.minSize, m = i.isHorizontal();
                        if (m ? (g.width = i.maxWidth, g.height = o ? 10 : 0) : (g.width = o ? 10 : 0, g.height = i.maxHeight), o)
                        {
                            if (s.font = f, m)
                            {
                                var v = i.lineWidths = [0], b = i.legendItems.length ? d + r.padding : 0;
                            ...
                            {
                                var y = r.padding, x = i.columnWidths = [], w = r.padding, k = 0, S = 0, C = d + y;
                    ...
                    draw: function ()
                    {
                        var i = this, n = i.options, r = n.labels, o = t.defaults.global, s = o.elements.line, l = i.width, u = i.lineWidths;
                        if (n.display)
                        {
                            var d, c = i.ctx, h = e.getValueOrDefault, f = h(r.fontColor, o.defaultFontColor), p = h(r.fontSize, o.defaultFontSize), g = h(r.fontStyle, o.defaultFontStyle), m = h(r.fontFamily, o.defaultFontFamily), v = e.fontString(p, g, m);
                            c.textAlign = "left", c.textBaseline = "top", c.lineWidth = .5, c.strokeStyle = f, c.fillStyle = f, c.font = v;
                            var b = a(r, p), y = i.legendHitBoxes, x = i.isHorizontal();
                            d = x ? {
                                x: i.left + (l - u[0]) / 2,
                                y: i.top + r.padding,
                                line: 0
                            ...
                            {
                                var f, g, m, v, k = c.measureText(e.text).width, S = b + p / 2 + k, C = d.x, M = d.y;
                                x ? C + S >= l && (M = d.y += w, d.line++, C = d.x = i.left + (l - u[d.line]) / 2) : M + w > i.bottom && (C = d.x = C + i.columnWidths[d.line] + r.padding, M = d.y = i.top + r.padding, d.line++), function (e, i, a)
                                {
                                    if (!(isNaN(b) || b <= 0))
                                    {
                                        ...
                                        {
                                            var l = p * Math.SQRT2 / 2, u = l / Math.SQRT2, d = e + u, f = i + u;
                                            t.canvasHelpers.drawPoint(c, a.pointStyle, l, d, f)
                                        }
                                        else
                                        {
                                            r || c.strokeRect(e, i, b, p), c.fillRect(e, i, b, p);
                                        }
                                        c.restore()
                                    }
                    ...
                    {
                        var a = n.options.legend, o = n.legend;
        ...
        43: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                return t.defaults.global.title = {
                    ...
                    fit: function ()
                    {
                        var i = this, n = e.getValueOrDefault, a = i.options, r = t.defaults.global, o = a.display, s = n(a.fontSize, r.defaultFontSize), l = i.minSize;
                    ...
                    draw: function ()
                    {
                        var i = this, n = i.ctx, a = e.getValueOrDefault, r = i.options, o = t.defaults.global;
                        if (r.display)
                        {
                            var s, l, u, d = a(r.fontSize, o.defaultFontSize), c = a(r.fontStyle, o.defaultFontStyle), h = a(r.fontFamily, o.defaultFontFamily), f = e.fontString(d, c, h), p = 0, g = i.top, m = i.left, v = i.bottom, b = i.right;
                    ...
                    beforeUpdate: function (n)
                    {
                        var r = n.options.title, o = n.titleBlock;
        ...
        44: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                var e = t.helpers, i = t.Scale.extend({
                    getLabels: function ()
                    {
                    ...
                    {
                        var e = this, i = Math.max(e.ticks.length - (e.options.gridLines.offsetGridLines ? 0 : 1), 1), n = e.isHorizontal(), a = (n ? e.width : e.height) / i;
        ...
        45: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                var e = t.helpers, i = {
                    ...
                    determineDataLimits: function ()
                    {
                        var t = this, i = t.options, n = t.chart, a = n.data.datasets, r = t.isHorizontal();
                            ...
                            }), i.stacked || s)
                        {
                            ...
                            {
                                var s = n.getDatasetMeta(r), u = [s.type,
                            ...
                            {
                                var n = i.positiveValues.concat(i.negativeValues), a = e.min(n), r = e.max(n);
                    ...
                    getTickLimit: function ()
                    {
                        ...
                        {
                            i = Math.min(n.maxTicksLimit ? n.maxTicksLimit : 11, Math.ceil(this.width / 50));
                        }
                        else
                        {
                    ...
                    {
                        var e, i = this, n = i.start, a = +i.getRightValue(t), r = i.end - n;
            ...
            e.exports = function (t)
            {
                ...
                t.LinearScaleBase = t.Scale.extend({
                    handleTickRangeOptions: function ()
                    {
                        ...
                        if (i.beginAtZero)
                        {
                            var n = e.sign(t.min), a = e.sign(t.max);
                    ...
                    buildTicks: function ()
                    {
                        var i = this, n = i.options.ticks, a = i.getTickLimit(), r = {
        ...
        47: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                var e = t.helpers, i = {
                    ...
                    determineDataLimits: function ()
                    {
                        var t = this, i = t.options, n = i.ticks, a = t.chart, r = a.data.datasets, o = e.getValueOrDefault, s = t.isHorizontal();
                    ...
                    buildTicks: function ()
                    {
                        var i = this, n = i.options.ticks, a = {
                            min: n.min,
                            max: n.max
                    ...
                    getPixelForValue: function (t)
                    {
                        var i, n, a, r = this, o = r.start, s = +r.getRightValue(t), l = r.options.ticks;
        ...
        48: [function (t, e, i)
        {
            ...
            e.exports = function (t)
            {
                ...
                function r(t)
                {
                    var n = t.options.pointLabels, a = e.getValueOrDefault(n.fontSize, i.defaultFontSize), r = e.getValueOrDefault(n.fontStyle, i.defaultFontStyle), o = e.getValueOrDefault(n.fontFamily, i.defaultFontFamily);
                    return {
                        size: a,
                        style: r,
                        family: o,
                ...
                var u = t.LinearScaleBase.extend({
                    setDimensions: function ()
                    {
                        var t = this, n = t.options, a = n.ticks;
                        t.width = t.maxWidth, t.height = t.maxHeight, t.xCenter = Math.round(t.width / 2), t.yCenter = Math.round(t.height / 2);
                        var r = e.min([t.height,
                            t.width]), o = e.getValueOrDefault(a.fontSize, i.defaultFontSize);
                        t.drawingArea = n.display ? r / 2 - (o / 2 + a.backdropPaddingY) : r / 2
                    },
                    determineDataLimits: function ()
                    {
                        var t = this, i = t.chart, n = Number.POSITIVE_INFINITY, a = Number.NEGATIVE_INFINITY;
                    ...
                    getTickLimit: function ()
                    {
                        var t = this.options.ticks, n = e.getValueOrDefault(t.fontSize, i.defaultFontSize);
                    ...
                    fit: function ()
                    {
                        ...
                        {
                            var i, n, s, l = r(t), u = Math.min(t.height / 2, t.width / 2), d = {
                                r: t.width,
                                l: 0,
                                t: t.height,
                                b: 0
                            ...
                            for (i = 0; i < g; i++)
                            {
                                ...
                                var m = t.getIndexAngle(i), v = e.toDegrees(m) % 360, b = o(v, s.x, n.w, 0, 180), y = o(v, s.y, n.h, 90, 270);
                    ...
                    {
                        var n = e.l / Math.sin(i.l), a = Math.max(e.r - this.width, 0) / Math.sin(i.r), r = -e.t / Math.cos(i.t), o = -Math.max(e.b - this.height, 0) / Math.cos(i.b);
                    ...
                    {
                        var a = this, r = a.width - e - a.drawingArea, o = t + a.drawingArea, s = i + a.drawingArea, l = a.height - n - a.drawingArea;
                    ...
                    draw: function ()
                    {
                        var t = this, n = t.options, o = n.gridLines, l = n.ticks, u = e.getValueOrDefault;
                        if (n.display)
                        {
                            var d = t.ctx, c = u(l.fontSize, i.defaultFontSize), h = u(l.fontStyle, i.defaultFontStyle), f = u(l.fontFamily, i.defaultFontFamily), p = e.fontString(c, h, f);
                            e.each(t.ticks, function (r, s)
                            {
                                if (s > 0 || n.reverse)
                                {
                                    var h = t.getDistanceFromCenterForValue(t.ticksAsNumbers[s]), f = t.yCenter - h;
                                    if (o.display && 0 !== s && function (t, i, n, r)
                                        {
                                            var o = t.ctx;
                                            if (o.strokeStyle = e.getValueAtIndexOrDefault(i.color, r - 1), o.lineWidth = e.getValueAtIndexOrDefault(i.lineWidth, r - 1), t.options.gridLines.circular)
                                            {
                                                o.beginPath(), o.arc(t.xCenter, t.yCenter, n, 0, 2 * Math.PI), o.closePath(), o.stroke();
                                            }
                                            else
                                            {
                                                var s = a(t);
                                        ...
                                        }(t, o, h, s), l.display)
                                    {
                                        ...
                                        if (d.font = p, l.showLabelBackdrop)
                                        {
                                            ...
                                            d.fillStyle = l.backdropColor, d.fillRect(t.xCenter - m / 2 - l.backdropPaddingX, f - c / 2 - l.backdropPaddingY, m + 2 * l.backdropPaddingX, c + 2 * l.backdropPaddingY)
                                        }
                            ...
                            {
                                var n = t.ctx, o = e.getValueOrDefault, l = t.options, u = l.angleLines, d = l.pointLabels;
                                n.lineWidth = u.lineWidth, n.strokeStyle = u.color;
                                var c, h, f, p, g = t.getDistanceFromCenterForValue(l.reverse ? t.min : t.max), m = r(t);
                                n.textBaseline = "top";
                                for (var v = a(t) - 1; v >= 0; v--)
                                {
                                    ...
                                    if (d.display)
                                    {
                                        var y = t.getPointPosition(v, g + 5), x = o(d.fontColor, i.defaultFontColor);
                                        n.font = m.font, n.fillStyle = x;
                                        var w = t.getIndexAngle(v), k = e.toDegrees(w);
                                        n.textAlign = 0 === (p = k) || 180 === p ? "center" : p < 180 ? "left" : "right", c = k, h = t._pointLabelSizes[v], f = y, 90 === c || 270 === c ? f.y -= h.h / 2 : (c > 270 || c < 90) && (f.y -= h.h), s(n, t.pointLabels[v] || "", y, m.size)
                                    }
                                }
                            }(t)
                        }
        ...
        49: [function (t, e, i)
        {
            ...
            n = "function" == typeof n ? n : window.moment, e.exports = function (t)
            {
                ...
                t.Ticks.generators.time = function (t, e)
                {
                    ...
                    return "week" === t.unit && !1 !== r ? (i = n(e.min).startOf("isoWeek").isoWeekday(r).valueOf(), a = n(e.max).startOf("isoWeek").isoWeekday(r), e.max - a > 0 && a.add(1, "week"), a = a.valueOf()) : (i = n(e.min).startOf(t.unit).valueOf(), a = n(e.max).startOf(t.unit), e.max - a > 0 && a.add(1, t.unit), a = a.valueOf()), function (t, e, i)
                    {
                        ...
                        if (t.maxTicks)
                        {
                            ...
                            for (var o = n(i.min); o.add(r, t.unit).valueOf() < i.max;)
                            {
                                a.push(o.valueOf());
                            }
                            var s = t.max || i.max;
                ...
                var r = t.Scale.extend({
                    ...
                    determineDataLimits: function ()
                    {
                        var t, i = this, n = i.options.time, r = Number.MAX_SAFE_INTEGER, o = Number.MIN_SAFE_INTEGER, s = i.chart.data, l = {
                            labels: [],
                            datasets: []
                        };
                    ...
                    buildTicks: function ()
                    {
                        var n, r, o = this, s = o.options.time, l = o.dataMin, u = o.dataMax;
                        if (s.min)
                        {
                            var d = a(o, s.min);
                        ...
                        var c = o.getLabelCapacity(n || l), h = s.unit || function (t, e, n, a)
                            {
                                for (var r, o = Object.keys(i), s = o.length, l = o.indexOf(t); l < s; l++)
                                {
                                    r = o[l];
                                    var u = i[r], d = u.steps && u.steps[u.steps.length - 1] || u.maxStep;
                                    if (void 0 === d || Math.ceil((n - e) / (d * u.size)) <= a)
                                    {
                                        break
                                    }
                                }
                        ...
                        var f = s.stepSize || function (t, e, n, a)
                            {
                                var r = i[n], o = r.size, s = Math.ceil((e - t) / o), l = 1, u = e - t;
                                if (r.steps)
                                {
                                    for (var d = r.steps.length, c = 0; c < d && s > a; c++)
                                    {
                    ...
                    getLabelForIndex: function (t, e)
                    {
                        var i = this.chart.data.labels && t < this.chart.data.labels.length ? this.chart.data.labels[t] : "", n = this.chart.data.datasets[e].data[t];
                    ...
                    {
                        var e = this.max - this.min, i = e ? (t - this.min) / e : 0;
                        if (this.isHorizontal())
                        {
                            var n = this.width * i;
                    ...
                    {
                        var n = null;
                        if (void 0 !== e && void 0 !== i && (n = this._parsedData.datasets[i][e]), null === n && (t && t.isValid || (t = a(this, this.getRightValue(t))), t && t.isValid && t.isValid() && (n = t.valueOf())), null !== n)
                        {
                    ...
                    getValueForPixel: function (t)
                    {
                        var e = this.isHorizontal() ? this.width : this.height, i = (t - (this.isHorizontal() ? this.left : this.top)) / e;
                        return n(this.min + i * (this.max - this.min))
                    },
                    getLabelWidth: function (i)
                    {
                        var n = this.options.ticks, a = this.ctx.measureText(i).width, r = Math.cos(e.toRadians(n.maxRotation)), o = Math.sin(e.toRadians(n.maxRotation));
                    ...
                    getLabelCapacity: function (t)
                    {
                        ...
                        var e = this.tickFormatFunction(n(t), 0, []), i = this.getLabelWidth(e);
    ...
    WOW = function ()
    {
        return {
            init: function ()
            {
                ...
                function a(t)
                {
                    var e = t.getBoundingClientRect(), i = document.body, n = document.documentElement, a = window.pageYOffset || n.scrollTop || i.scrollTop, r = n.clientTop || i.clientTop || 0, o = e.top + a - r;
                    return Math.round(o)
                }
...
}("object" == typeof global ? global : this, function ()
{
    ...
    function d(t, e, i)
    {
        if (i)
        {
            ...
            var n = i.getAttribute("data-x"), a = i.getAttribute("data-y"), r = i.getAttribute("data-scale"), o = i.getAttribute("data-translate"), u = 350 - (Date.now() - Number(i.getAttribute("data-hold")));
    ...
    }, t.attach = function (t, e)
    {
        ...
        {
            a = (n = t[o]).tagName.toLowerCase(), -1 !== ["input",
                "img"].indexOf(a) && (u[a](n), n = n.parentElement), -1 === n.className.indexOf("waves-effect") && (n.className += " waves-effect" + e)
        }
...
}), Waves.attach(".btn:not(.btn-flat), .btn-floating", ["waves-light"]), Waves.attach(".btn-flat", ["waves-effect"]), Waves.attach(".view a .mask", ["waves-light"]), Waves.attach(".waves-light", ["waves-light"]), Waves.attach(".navbar-nav a:not(.navbar-brand), .nav-icons li a, .navbar input, .nav-tabs .nav-item:not(.dropdown)", ["waves-light"]), Waves.attach(".pager li a", ["waves-light"]), Waves.attach(".pagination .page-item .page-link", ["waves-effect"]), Waves.init(), function (t)
{
    t(document).ready(function ()
    {
        var e = ["text",
                ...
                "number",
                "search",
                "search-md"].map(function (t)
            {
                return "input[type=" + t + "]"
            }).join(", ") + ", textarea", i = ".materialize-textarea", n = function (t)
        {
        ...
        {
            var a = t(i), r = a.siblings("label, i");
        ...
        {
            var i = t(e.target), n = !i.val(), r = !e.target.validity.badInput, o = void 0 === i.attr("placeholder");
