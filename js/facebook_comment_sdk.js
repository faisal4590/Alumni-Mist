/**
 * Created by faisal on 4/16/2018.
 */
/*1523895460,,JIT Construction: v3815795,en_US*/
...
try
{
    window.FB || (function (window, fb_fif_window)
    {
        ...
        var sandboxWhitelist = ['setTimeout',
            'setInterval',
            'clearTimeout',
            'clearInterval'];
            ...
            with (this)
            {
                ...
                __d("ie8DontEnum", [], (function a(b, c, d, e, f, g)
                {
                    var h = ["toString",
                        ...
                        "constructor"], i = {}.hasOwnProperty, j = function j()
                    {
                    };
                ...
                __d("ES7ArrayPrototype", ["ES5ArrayPrototype",
                    "ES5Array"], (function a(b, c, d, e, f, g, h, i)
                {
                    __p && __p();
                    ...
                    var o = {
                        includes: function p(q)
                        {
                            "use strict";
                            __p && __p();
                            if (q !== undefined && k(this) && !(typeof q === "number" && isNaN(q)))
                            {
                            ...
                            var t = arguments.length > 1 ? m(arguments[1]) : 0, u = t < 0 ? Math.max(s + t, 0) : t, v = isNaN(q) && typeof q === "number";
                            while (u < s)
                            {
                                var w = r[u];
                ...
                __d("json3-3.3.2", [], (function aa(ba, ca, da, ea, fa, a)
                {
                    ...
                    function ga()
                    {
                        ...
                        {
                            __p && __p();
                            var e = typeof d === "function" && d.amd, f = {
                                "function": true,
                                object: true
                            }, g = f[typeof b] && b && !b.nodeType && b, h = f[typeof window] && window || this, i = g && f[typeof c] && c && !c.nodeType && typeof ba == "object" && ba;
                            ...
                            function j(m, a)
                            {
                                ...
                                m || (m = h.Object());
                                a || (a = h.Object());
                                var ma = m.Number || h.Number, na = m.String || h.String, oa = m.Object || h.Object, n = m.Date || h.Date, pa = m.SyntaxError || h.SyntaxError, qa = m.TypeError || h.TypeError, ra = m.Math || h.Math, k = m.JSON || h.JSON;
                                    ...
                                    else
                                    {
                                        ...
                                        if (J == "json-stringify")
                                        {
                                            ...
                                            if (O)
                                            {
                                                ...
                                                try
                                                {
                                                    O = N(0) === "0" && N(new ma()) === "0" && N(new na()) == '""' && N(o) === r && N(r) === r && N() === r && N(L) === "1" && N([L]) == "[1]" && N([r]) == "[null]" && N(null) == "null" && N([r,
                                                            o,
                                ...
                                if (!u("json"))
                                {
                                    var v = "[object Function]", ta = "[object Date]", w = "[object Number]", x = "[object String]", y = "[object Array]", ua = "[object Boolean]", z = u("bug-string-char-index");
                                    if (!s)
                                    {
                                        var A = ra.floor, va = [0,
                                            31,
                                    ...
                                    if (!(p = sa.hasOwnProperty))
                                    {
                                        p = function (J)
                                        {
                                            __p && __p();
                                            var K = {}, L;
                                            if ((K.__proto__ = null, K.__proto__ = {toString: 1}, K).toString != o)
                                            {
                                                p = function (J)
                                                {
                                    ...
                                    q = function (J, K)
                                    {
                                        ...
                                        if (!L)
                                        {
                                            ...
                                            q = function (J, K)
                                            {
                                                var P = o.call(J) == v, O, Q, R = !P && typeof J.constructor != "function" && f[typeof J.hasOwnProperty] && J.hasOwnProperty || p;
                                                for (O in J)
                                                {
                                        ...
                                        else if (L == 2)
                                        {
                                            q = function (J, K)
                                            {
                                                ...
                                                for (O in J)
                                                {
                                                    if (!(P && O == "prototype") && !p.call(N, O) && (N[O] = 1) && p.call(J, O))
                                                    {
                                                        K(O)
                                                    }
                                                }
                                        ...
                                        else
                                        {
                                            q = function (J, K)
                                            {
                                                ...
                                                for (O in J)
                                                {
                                                    if (!(P && O == "prototype") && p.call(J, O) && !(Q = O === "constructor"))
                                                    {
                                                        K(O);
                                                    }
                                                }
                                                if (Q || p.call(J, O = "constructor"))
                                                {
                                                    K(O)
                                                }
                                            };
                                    ...
                                    if (!u("json-stringify"))
                                    {
                                        ...
                                        {
                                            __p && __p();
                                            var K = '"', L = 0, M = J.length, N = !z || M > 10, O = N && (z ? J.split("") : J);
                                            for (; L < M; L++)
                                            {
                                        ...
                                        }, D = function (J, K, L, M, N, O, P)
                                        {
                                            ...
                                            if (typeof Q == "object" && Q)
                                            {
                                                ...
                                                else if (typeof Q.toJSON == "function" && (R != w && R != x && R != y || p.call(Q, "toJSON")))
                                                {
                                                    Q = Q.toJSON(J)
                                                }
                                            }
                                            ...
                                            while (E < K)
                                            {
                                                ...
                                                switch (P)
                                                {
                                                    ...
                                                    default:
                                                        ...
                                                        if (P >= 48 && P <= 57)
                                                        {
                                                            if (P == 48 && (P = J.charCodeAt(E + 1), P >= 48 && P <= 57))
                                                            {
                                                                G();
                                                            }
                                                            O = false;
                                            ...
                                            if (typeof J == "string")
                                            {
                                                ...
                                                else if (J == "{")
                                                {
                                                    ...
                                                    for (; ; L || (L = true))
                                                    {
                                                        ...
                                                        if (J == "," || typeof J != "string" || (z ? J.charAt(0) : J[0]) != "@" || H() != ":")
                                                        {
                                                            G();
                                                        }
                                                        K[J.slice(1)] = I(H())
                ...
                __d("ES", ["json3",
                    ...
                    "ES7StringPrototype",
                    "ES7Object",
                    "ES7ArrayPrototype"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v)
                {
                    __p && __p();
                    var w = {}.toString, x = {
                    ...
                    function C(D, E, F)
                    {
                        ...
                        {
                            for (var I = arguments.length, J = Array(I > 3 ? I - 3 : 0), K = 3; K < I; K++)
                            {
                                J[K - 3] = arguments[K];
                            }
                            return H.apply(D, J)
                ...
                __d("sdk.babelHelpers", ["ES5FunctionPrototype",
                    "ES5Object",
                    "ES6Object"], (function a(b, c, d, e, f, g, h, i, j)
                {
                    __p && __p();
                        ...
                        if (!l)
                        {
                            m = function ()
                            {
                                ...
                                m.prototype.next = function ()
                                {
                                    ...
                                    var n = this.$ArrayIterator1, o = this.$ArrayIterator1.length, p = this.$ArrayIterator3, q = this.$ArrayIterator2;
                                    if (p >= o)
                                    {
                    ...
                    var g = a.FB_enumerate, h = function ()
                    {
                        ...
                        function q(A, B)
                        {
                            ...
                            else
                            {
                                ...
                                if (typeof B === "string")
                                {
                                    return A._stringIndex[D];
                                }
                                else
                                {
                                    return A._otherIndex[D]
                                }
                            }
                        }
                        ...
                        function v(A)
                        {
                            if (!h.__isES5 || !Object.isExtensible)
                            {
                                return true;
                            }
                            else
                        ...
                        function y(A)
                        {
                            ...
                            else if (!h.__isES5 && A.propertyIsEnumerable && A.propertyIsEnumerable[x])
                            {
                                return A.propertyIsEnumerable[x];
                            }
                            else if (!h.__isES5 && e(A) && w(A))
                            {
                                return w(A);
                            }
                            else if (!h.__isES5 && A[x])
                            {
                                return A[x]
                            }
                        }
                ...
                __d("JSSDKXDConfig", [], {
                    ...
                    "XdBundleUrl": "\/connect\/xd_arbiter\/r\/FdM1l_dpErI.js?version=42",
                ...
                __d("GlobalCallback", ["DOMWrapper",
                    "dotAccess",
                    "guid",
                    "wrapFunction"], (function a(b, c, d, e, f, g, h, i, j, k)
                {
                    __p && __p();
                    var l, m, n = {
                ...
                __d("Assert", ["AssertionError",
                    "sprintf"], (function a(b, c, d, e, f, g, h, i)
                {
                    __p && __p();
                    function j(o, p)
                    {
                    ...
                    ES(["Array",
                        ...
                        "Regexp",
                        "String",
                        "Undefined"], "forEach", true, function (o)
                    {
                ...
                __d("sdk.Model", ["Type",
                    "ObservableMixin"], (function a(b, c, d, e, f, g, h, i)
                {
                    __p && __p();
                    var j = h.extend({
                ...
                __d("sdk.Runtime", ["sdk.Model",
                    "JSSDKRuntimeConfig"], (function a(b, c, d, e, f, g, h, i)
                {
                    __p && __p();
                    var j = {
                        UNKNOWN: 0,
                ...
                __d("sdk.Cookie", ["QueryString",
                    "sdk.Runtime"], (function a(b, c, d, e, f, g, h, i)
                {
                    __p && __p();
                    var j = null;
                ...
                __d("insertIframe", ["GlobalCallback",
                    "getBlankIframeSrc",
                    "guid"], (function a(b, c, d, e, f, g, h, i, j)
                {
                    __p && __p();
                    function k(l)
                    {
                ...
                __d("sdk.Content", ["Log",
                    "sdk.UA",
                    "sdk.domReady"], (function a(b, c, d, e, f, g, h, i, j)
                {
                    __p && __p();
                    var k, l, m = {
                ...
                __d("sdk.Impressions", ["sdk.Content",
                    "Miny",
                    "QueryString",
                    "sdk.Runtime",
                    "UrlMap",
                    "getBlankIframeSrc",
                    "guid",
                    "insertIframe"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o)
                {
                    __p && __p();
                    function p(r)
                    {
                ...
                __d("sdk.Scribe", ["QueryString",
                    "sdk.Runtime",
                    "UrlMap"], (function a(b, c, d, e, f, g, h, i, j)
                {
                    function k(m, n)
                    {
                ...
                __d("URIBase", ["URIRFC3986",
                    "URISchemes",
                    "ex",
                    "invariant",
                    "setHostSubdomain"], (function a(b, c, d, e, f, g, h, i, j, k, l)
                {
                    __p && __p();
                ...
                __d("sdk.URI", ["Assert",
                    "QueryString",
                    "URIBase"], (function a(b, c, d, e, f, g, h, i, j)
                {
                    __p && __p();
                ...
                __d("DOMEventListener", ["emptyFunction",
                    "invariant",
                    "wrapFunction"], (function a(b, c, d, e, f, g, h, i, j)
                {
                    __p && __p();
                    var k = false;
                    try
                ...
                __d("UserAgent_DEPRECATED", [], (function a(b, c, d, e, f, g)
                {
                    ...
                    function x()
                    {
                        ...
                        h = true;
                        var z = navigator.userAgent, A = /(?:MSIE.(\d+\.\d+))|(?:(?:Firefox|GranParadiso|Iceweasel).(\d+\.\d+))|(?:Opera(?:.+Version.|.)(\d+\.\d+))|(?:AppleWebKit.(\d+(?:\.\d+)?))|(?:Trident\/\d+\.\d+.*rv:(\d+\.\d+))/.exec(z), B = /(Mac OS X)|(Windows)|(Linux)/.exec(z);
                ...
                __d("Flash", ["DOMEventListener",
                    "DOMWrapper",
                    "QueryString",
                    "UserAgent_DEPRECATED",
                    "guid",
                    "htmlSpecialChars"], (function a(b, c, d, e, f, g, h, i, j, k, l, m)
                {
                    __p && __p();
                    ...
                    var u = {
                        embed: function v(w, x, y, z)
                        {
                            ...
                            for (var C in y)
                            {
                                if (Object.prototype.hasOwnProperty.call(y, C) && y[C])
                                {
                                    B.push('<param name="' + m(C) + '" value="' + m(y[C]) + '">');
                                }
                            }
                            var D = x.appendChild(p.createElement("span")), E = "<object " + (k.ie() ? 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ' : 'type="application/x-shockwave-flash"') + 'data="' + w + '" ' + (y.height ? 'height="' + y.height + '" ' : "") + (y.width ? 'width="' + y.width + '" ' : "") + 'id="' + A + '">' + B.join("") + "</object>";
                            D.innerHTML = E;
                            var F = D.firstChild;
                            t(A);
                            return F
                        ...
                        getVersion: function v()
                        {
                            ...
                            if (navigator.plugins && typeof navigator.plugins[w] == "object")
                            {
                                ...
                                if (A && navigator.mimeTypes && navigator.mimeTypes[x] && navigator.mimeTypes[x].enabledPlugin)
                                {
                                    z = A.match(/\d+/g)
                                }
                            }
                ...
                __d("XDM", ["DOMEventListener",
                    ...
                    "Log",
                    "UserAgent_DEPRECATED",
                    "wrapFunction"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p)
                {
                    __p && __p();
                        ...
                        return {
                            ...
                            init: function x(y)
                            {
                                ...
                                h.add(s, "message", p(function (event)
                                {
                                    ...
                                    if (C !== "native" && !(v.test(location.hostname) || v.test(event.origin)))
                                    {
                                        return;
                                    }
                                    if (typeof B != "string")
                ...
                __d("sdk.RPC", ["Assert",
                    "JSONRPC",
                    "Queue"], (function a(b, c, d, e, f, g, h, i, j)
                {
                ...
                __d("hasNamePropertyBug", ["guid",
                    "UserAgent_DEPRECATED"], (function a(b, c, d, e, f, g, h, i)
                {
                    __p && __p();
                ...
                __d("sdk.createIframe", ["DOMEventListener",
                    "getBlankIframeSrc",
                    "guid",
                    "hasNamePropertyBug",
                    "isNumberLike"], (function a(b, c, d, e, f, g, h, i, j, k, l)
                {
                    __p && __p();
                    function m(n)
                    {
                ...
                __d("sdk.feature", ["sdk.FeatureFunctor",
                    "JSSDKConfig"], (function a(b, c, d, e, f, g, h, i)
                {
                    f.exports = h.create(i)
                }), null);
                __d("sdk.XD", ["sdk.Content",
                    "sdk.Event",
                    "Log",
                    "QueryString",
                    "Queue",
                    ...
                    "sdk.createIframe",
                    "sdk.feature",
                    "guid"], (function a(b, c, d, e, f, aa, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v)
                {
                    __p && __p();
                    var w = new k(), x = new k(), y = new k(), z, A, B = v(), C = q.useCdn ? "cdn" : "www", D = u("use_bundle", false) ? q.XdBundleUrl : q.XdUrl, E = p.resolve(C, false) + D, F = p.resolve(C, true) + D, G = function G()
                    {
                    ...
                    }, H = v(), I = G(), J, K = false, L = "Facebook Cross Domain Communication Frame", M = {}, N = new k();
                    l.setInQueue(N);
                    function O(U)
                    {
                ...
                __d("sdk.getContextType", ["sdk.Runtime",
                    "sdk.UA"], (function a(b, c, d, e, f, g, h, i)
                {
                    function j()
                    {
                        if (i.nativeApp())
                ...
                __d("sdk.Auth", ["sdk.Cookie",
                    ...
                    "UrlMap",
                    "sdk.URI",
                    "sdk.XD"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v)
                {
                    __p && __p();
                    ...
                    function B(J, K)
                    {
                        ...
                        var O = q.getLoginStatus(), P = O === "unknown" && J || q.getUseCookie() && q.getCookieUserID() !== M, Q = L && !J, R = J && L && L != M, S = J != y, T = K != (O || "unknown");
                        q.setLoginStatus(K);
                        ...
                        if (S)
                        {
                            A.inform("authresponse.change", U);
                        }
                        if (T)
                        {
                            A.inform("status.change", U);
                        }
                        return U
                    }
                    ...
                    function D(J, K, L)
                    {
                        ...
                        return function (M)
                        {
                            ...
                            if (M && M.access_token)
                            {
                                ...
                                if (M.granted_scopes)
                                {
                                    K.grantedScopes = M.granted_scopes;
                                }
                                if (q.getUseCookie())
                                {
                                    var P = K.expiresIn === 0 ? 0 : ES("Date", "now", false) + K.expiresIn * 1e3, Q = h.getDomain();
                                    if (!Q && M.base_domain)
                                    {
                                        h.setDomain("." + M.base_domain);
                                    }
                            ...
                            {
                                if (M.error && M.error === "not_authorized")
                                {
                                    N = "not_authorized";
                                }
                                else
                    ...
                    function G(J)
                    {
                        ...
                        var O = D(J, y, "login_status"), P = new u(t.resolve("www", true) + "/connect/ping").setQueryData({
                    ...
                    "sdk.domReady"], (function a(b, c, d, e, f, g, h, i, j)
                {
                    ...
                    function l(A, B)
                    {
                        var C = A.getAttribute(B) || A.getAttribute(B.replace(/_/g, "-")) || A.getAttribute(B.replace(/-/g, "_")) || A.getAttribute(B.replace(/-/g, "")) || A.getAttribute(B.replace(/_/g, "")) || A.getAttribute("data-" + B) || A.getAttribute("data-" + B.replace(/_/g, "-")) || A.getAttribute("data-" + B.replace(/-/g, "_")) || A.getAttribute("data-" + B.replace(/-/g, "")) || A.getAttribute("data-" + B.replace(/_/g, ""));
                    ...
                    {
                        var C = l(A, B);
                        return C ? /^(true|1|yes|on)$/.test(C) : null
                    }

                    function n(A, B)
                    {
                        h.isTruthy(A, "element not specified");
                        h.isString(B);
                        try
                        {
                            return String(A[B])
                        ...
                        {
                            throw new Error("Could not read property " + B + " : " + C.message)
                        }
                    }
                    ...
                    function o(A, B)
                    {
                        ...
                        {
                            throw new Error("Could not set innerHTML : " + C.message)
                        }
                    }
                    ...
                    function r(A, B)
                    {
                        ...
                        A.className = ES(n(A, "className").replace(C, ""), "trim", true)
                    }
                    ...
                    function s(A, B, C)
                    {
                        ...
                        {
                            return ES("Array", "from", false, B.querySelectorAll(C + "." + A));
                        }
                    ...
                    function t(A, B)
                    {
                        ...
                        var C = A.currentStyle || document.defaultView.getComputedStyle(A, null), D = C[B];
                        if (/backgroundPosition?/.test(B) && /top|left/.test(D))
                        {
                            D = "0%";
                        }
                        return D
                ...
                __d("sdk.ErrorHandler", ["ManagedError",
                    "normalizeError",
                    "wrapFunction"], (function a(b, c, d, e, f, g, h, i, j)
                {
                    __p && __p();
                ...
                __d("sdk.ErrorHandling", ["sdk.ErrorHandler",
                    "sdk.Runtime",
                    "sdk.Scribe",
                    "sdk.feature"], (function a(b, c, d, e, f, g, h, i, j, k)
                {
                ...
                __d("FB", ["sdk.Auth",
                    ...
                    "sdk.Runtime",
                    "sdk.Scribe",
                    "JSSDKConfig"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u)
                {
                    __p && __p();
                    ...
                    {
                        if (!D && s.getLoginStatus() === "connected")
                        {
                        ...
                        switch (H)
                        {
                            ...
                            default:
                                return m.guard(function ()
                                {
                                    ...
                                    function I(O)
                                    {
                                        if (ES("Array", "isArray", false, O))
                                        {
                                            return ES(O, "map", true, I);
                                        }
                                        if (O && typeof O === "object" && O.__wrapped)
                                        {
                                            return O.__wrapped;
                                        }
                                    ...
                                    var J = ES(Array.prototype.slice.call(arguments), "map", true, I), K = D.apply(G, J), L, M = true;
                                    if (K && typeof K === "object")
                                    {
                                        ...
                                        {
                                            var N = K[F];
                                            if (typeof N !== "function" || F === "constructor")
                                            {
                                                continue;
                                            }
                                            M = false;
                    ...
                    s.setSecure(function ()
                    {
                        ...
                        if (location.protocol == "https:" && (window == top || !(D || E)))
                        {
                            return true;
                        }
                ...
                __d("ApiClientUtils", ["ArgumentError",
                    ...
                    "sdk.URI",
                    "flattenObject",
                    "sprintf"], (function a(b, c, d, e, f, g, h, i, j, k, l, m)
                {
                    __p && __p();
                    var n = {
                        get: true,
                ...
                __d("ApiBatcher", ["ApiClientUtils",
                    "QueryString",
                    "invariant",
                    "sdk.safelyParseResponse"], (function a(b, c, d, e, f, g, h, i, j, k)
                {
                    "use strict";
                    __p && __p();
                    ...
                    n.prototype.scheduleBatchCall = function ()
                    {
                        ...
                        var r = n.prepareBatchParams(p), s = r.body, t = r.callback, u = r.method, v = r.relative_url, w = {
                            method: u,
                            relative_url: v
                        };
                        if (s)w.body = s;
                    ...
                    {
                        var p = h.parseCallDataFromArgs(o), q = p.uri, r = p.callback, s = p.params.method, t, u = q.removeQueryData("method").toString();
                    ...
                    "sdk.safelyParseResponse"], (function a(b, c, d, e, f, g, h, i, j, k)
                {
                    ...
                    function l(o, p)
                    {
                        ...
                        {
                            if (q.readyState == 4)if (q.status == 200)u();
                            else v()
                        };
                        return t
                    }
                    ...
                    function m(o, p, q, r)
                    {
                        ...
                        t.onerror = function (u)
                        {
                            ...
                            else r({error: babelHelpers["extends"]({}, j.PARSE_ERROR_TEMPLATE, {status: u.status})})
                        };
                        t.send(s);
                        return true
                    }
                ...
                __d("ChunkedRequest", ["GraphBatchConstants",
                    "QueryString",
                    "RequestConstants",
                    "sdk.safelyParseResponse",
                    "wrapFunction"], (function a(b, c, d, e, f, g, h, i, j, k, l)
                {
                    __p && __p();
                    var m = "{}";
                    ...
                    function o(r, s)
                    {
                        ...
                        {
                            if (t.readyState == 4)if (t.status === 200)w(t.responseText, true);
                            else x();
                    ...
                    function p(r, s, t, u)
                    {
                        ...
                        w.onerror = function (x)
                        {
                            ...
                            else u({error: babelHelpers["extends"]({}, j.PARSE_ERROR_TEMPLATE, {status: x.status})})
                        };
                        w.send(v);
                        return true
                    }
                ...
                __d("FlashRequest", ["DOMWrapper",
                    "Flash",
                    "GlobalCallback",
                    "QueryString",
                    "Queue"], (function a(b, c, d, e, f, g, h, i, j, k, l)
                {
                    __p && __p();
                    var m, n = {}, o, p;
                ...
                __d("JSONPRequest", ["DOMWrapper",
                    "GlobalCallback",
                    "QueryString"], (function a(b, c, d, e, f, g, h, i, j)
                {
                    __p && __p();
                    var k = 2e3, l = false;
                ...
                __d("ApiClient", ["ApiBatcher",
                    ...
                    "QueryString",
                    "UrlMap",
                    "ApiClientConfig"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t)
                {
                    __p && __p();
                    ...
                    function H()
                    {
                        ...
                        if (L(Q, T))T = "post";
                        var U = Q.getProtocol() && Q.getDomain() ? Q.setQueryData({}).toString() : s.resolve("graph") + Q.getPath(), V = D++;
                    ...
                    function J(M, N)
                    {
                        ...
                        M.api_key = v;
                        var P = O in y ? "api_read" : "api", Q = s.resolve(P) + "/restserver.php", R = D++, S = ES(G, "bind", true, null, N, "/restserver.php", "get", M, ES("Date", "now", false), R);
                        F(Q, "get", M, S)
                    }
                ...
                __d("sdk.PlatformVersioning", ["sdk.Runtime",
                    "ManagedError"], (function a(b, c, d, e, f, g, h, i)
                {
                    var j = /^v\d+\.\d\d?$/, k = {
                        REGEX: j,
                ...
                __d("sdk.api", ["ApiClient",
                    "sdk.PlatformVersioning",
                    "sdk.Runtime",
                    "sdk.Scribe",
                    "sdk.URI",
                    "sdk.feature"], (function a(b, c, d, e, f, g, h, i, j, k, l, m)
                {
                    __p && __p();
                ...
                __d("legacy:fb.api", ["FB",
                    "sdk.api"], (function a(b, c, d, e, f, g, h, i)
                {
                    h.provide("", {api: i})
                }), 3);
                ...
                __d("FBEventsUtils", [], (function a(b, c, d, e, f, g)
                {
                    "use strict";
                    __p && __p();
                    var h = "console", i = "error", j = "Facebook Pixel Error", k = "Facebook Pixel Warning", l = "warn", m = Object.prototype.toString, n = !("addEventListener" in document), o = function o()
                    {
                    ...
                    {
                        x = n ? "on" + x : x;
                        var z = n ? "attachEvent" : "addEventListener", A = n ? "detachEvent" : "removeEventListener", B = function B()
                        {
                            w[A](x, B, false);
                            y()
                        };
                ...
                __d("FBPixelEndpoint", ["FBEventsParamList",
                    "FBEventsUtils"], (function a(b, c, d, e, f, g, h, i)
                {
                    "use strict";
                    __p && __p();
                    ...
                    function q(s, t)
                    {
                        ...
                        var w = !!(window.attachEvent && !window.addEventListener), x = w ? '<iframe name="' + u + '">' : "iframe", y = document.createElement(x);
                ...
                __d("FBAppEvents", ["ApiClient",
                    "FBPixelEndpoint"], (function a(b, c, d, e, f, g, h, i)
                {
                    "use strict";
                    __p && __p();
                ...
                __d("sdk.AppEvents", ["AppUserPropertyAPIBuiltinField",
                    "Assert",
                    "sdk.Event",
                    "sdk.Impressions",
                    "sdk.Model",
                    "sdk.Runtime",
                    "FBAppEvents",
                    "sdk.Auth"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o)
                {
                    __p && __p();
                    ...
                    }), s = /^[0-9a-zA-Z_][0-9a-zA-Z _-]{0,39}$/, t = 40, u = s, v = t, w = 100, x = 100, y = 100, z = 100, A = ES("Object", "values", false, h), B = new l({
                        UserID: "",
                        Version: ""
                    });
                ...
                __d("legacy:fb.appevents", ["Assert",
                    "sdk.AppEvents",
                    "FB",
                    "sdk.Runtime"], (function a(b, c, d, e, f, g, h, i, j, k)
                {
                    __p && __p();
                    function l()
                    {
                ...
                __d("sdk.DialogUtils", ["sdk.Content",
                    "sdk.DOM",
                    "DOMEventListener",
                    "sdk.UA",
                    "sdk.feature"], (function a(b, c, d, e, f, g, h, i, j, k, l)
                {
                    "use strict";
                    __p && __p();
                    var m = {
                        ...
                        addMobileOrientationChangeAction: function n(o)
                        {
                            ...
                            var event = "onorientationchange" in window ? "orientationchange" : "resize", p = function p(q)
                            {
                ...
                __d("sdk.Dialog", ["sdk.Canvas.Environment",
                    "sdk.Content",
                    "sdk.DialogUtils",
                    "sdk.DOM",
                    "DOMEventListener",
                    ...
                    "sdk.UA",
                    "sdk.fbt",
                    "sdk.feature"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r)
                {
                    __p && __p();
                ...
                __d("sdk.NativeExtensions", ["Log",
                    "sdk.UA",
                    "sdk.domReady",
                    "DOMEventListener"], (function a(b, c, d, e, f, g, h, i, j, k)
                {
                    __p && __p();
                ...
                __d("sdk.Extensions", ["JSONRPC",
                    "Queue",
                    "sdk.UA",
                    "sdk.NativeExtensions"], (function a(b, c, d, e, f, g, h, i, j, k)
                {
                    "use strict";
                    __p && __p();
                ...
                __d("sdk.Frictionless", ["sdk.Auth",
                    "sdk.api",
                    "sdk.Event",
                    "sdk.Dialog"], (function a(b, c, d, e, f, g, h, i, j, k)
                {
                    __p && __p();
                    var l = {
                        _allowedRecipients: {},
                ...
                __d("sdk.UIServer", ["sdk.Auth",
                    ...
                    "insertIframe",
                    "sdk.openMessenger",
                    "resolveURI"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F)
                {
                    __p && __p();
                    var G = {
                    ...
                    var I = {
                        ...
                        "permissions.oauth": {
                            ...
                            transform: function N(O)
                            {
                                ...
                                var P = O.cb, Q = O.id;
                                delete O.cb;
                                var R = O.params.auth_type === "reauthenticate", S = ES("Object", "keys", false, ES("Object", "assign", false, O.params.response_type ? x(O.params.response_type.split(",")) : {}, {
                                    token: true,
                                    signed_request: true
                                })).join(",");
                    ...
                    var M = {
                        ...
                        {
                            __p && __p();
                            var Q = O.method.toLowerCase(), R = Object.prototype.hasOwnProperty.call(M.Methods, Q) ? ES("Object", "assign", false, {}, M.Methods[Q]) : {}, S = C(), T = s.getSecure() || Q !== "auth.status" && Q != "login.status";
                ...
                __d("sdk.ui", ["Assert",
                    ...
                    "sdk.Runtime",
                    "sdk.UIServer",
                    "sdk.feature"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n)
                {
                    __p && __p();
                    function o(p, q)
                    {
                    ...
                    "sdk.ui"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o)
                {
                    ...
                    j.subscribe("init:post", function (p)
                    {
                        ...
                        if (m.getClientID())if (p.authResponse)h.setAuthResponse(p.authResponse, "connected");
                ...
                __d("sdk.Canvas.IframeHandling", ["DOMWrapper",
                    "sdk.RPC"], (function a(b, c, d, e, f, g, h, i)
                {
                    __p && __p();
                    var j = null, k;
                ...
                __d("sdk.Canvas.Plugin", ["Log",
                    "sdk.RPC",
                    "sdk.Runtime",
                    "sdk.UA",
                    "sdk.api"], (function a(b, c, d, e, f, g, h, i, j, k, l)
                {
                    __p && __p();
                    ...
                    {
                        __p && __p();
                        var C = B.type ? B.type.toLowerCase() : null, D = C === "application/x-shockwave-flash" || B.classid && B.classid.toUpperCase() == m;
                        if (!D)return false;
                ...
                __d("legacy:fb.canvas", ["Assert",
                    ...
                    "sdk.RPC",
                    "sdk.Runtime",
                    "sdk.Canvas.Tti"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q)
                {
                    __p && __p();
                    k.provide("Canvas", {
                ...
                __d("legacy:fb.canvas.plugin", ["FB",
                    "sdk.Canvas.Plugin"], (function a(b, c, d, e, f, g, h, i)
                {
                    h.provide("Canvas.Plugin", i)
                }), 3);
                __d("sdk.Canvas.Prefetcher", ["JSSDKCanvasPrefetcherConfig",
                    "sdk.Runtime",
                    "sdk.api"], (function a(b, c, d, e, f, g, h, i, j)
                {
                    __p && __p();
                    var k = {
                        AUTOMATIC: 0,
                ...
                __d("legacy:fb.canvas.prefetcher", ["FB",
                ...
                __d("legacy:fb.canvas.presence", ["sdk.RPC",
                    "sdk.Event"], (function a(b, c, d, e, f, g, h, i)
                {
                    __p && __p();
                ...
                __d("legacy:fb.canvas.syncrequests", ["sdk.RPC",
                    "sdk.Event"], (function a(b, c, d, e, f, g, h, i)
                {
                ...
                __d("legacy:fb.frictionless", ["FB",
                    "sdk.Frictionless"], (function a(b, c, d, e, f, g, h, i)
                {
                    h.provide("Frictionless", i)
                }), 3);
                __d("sdk.MBasicInitializer", ["sdk.DOM",
                    "sdk.Runtime",
                    "sdk.UA",
                    "sdk.URI",
                    "UrlMap",
                ...
                __d("sdk.init", ["sdk.Cookie",
                    ...
                    "sdk.UA",
                    "sdk.URI",
                    "sdk.feature"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t)
                {
                    __p && __p();
                    function u(w)
                    {
                ...
                __d("legacy:fb.init", ["FB",
                    "sdk.init"], (function a(b, c, d, e, f, g, h, i)
                {
                    h.provide("", {init: i})
                }), 3);
                __d("sdk.Time", ["Log",
                    ...
                    "sdk.feature"], (function a(b, c, d, e, f, g, h, i, j, k)
                {
                    "use strict";
                    __p && __p();
                    var l = window.performance, m = l && "now" in l && "getEntriesByName" in l && k("log_perf", false), n = void 0, o = {};
                    if (m)
                    {
                        var p = l.getEntriesByName(j.getSDKUrl())[0];
                        if (p)
                        {
                            o.fetchTime = parseInt(p.duration, 10);
                            if ("transferSize" in p)o.transferSize = parseInt(p.transferSize, 10);
                            h.debug("sdkperf: it took %s ms and %s bytes to load %s", parseInt(p.duration, 10), parseInt(p.transferSize, 10), j.getSDKUrl());
                            n = p.startTime;
                            o.ns = j.getSDKNS();
                    ...
                    var q = {
                        ...
                        {
                            if (!m || !n)return;
                            o[s] = parseInt(l.now() - n, 10);
                            h.debug("sdkperf: %s logged after %s ms", s, o[s])
                        }
                    };
                    f.exports = q
                }), null);
                __d("legacy:fb.time", ["sdk.Event",
                    "sdk.Time"], (function a(b, c, d, e, f, g, h, i)
                {
                    "use strict";
                ...
                __d("legacy:fb.ui", ["FB",
                    "sdk.ui"], (function a(b, c, d, e, f, g, h, i)
                {
                    h.provide("", {ui: i})
                }), 3);
                ...
                __d("XFBML", ["Assert",
                    ...
                    "ObservableMixin",
                    "sdk.UA",
                    "runOnce"], (function a(b, c, d, e, f, g, h, i, j, k, l, m)
                {
                    __p && __p();
                    var n = {}, o = {}, p = 0, q = new k();
                ...
                __d("legacy:fb.xfbml", ["Assert",
                    "sdk.Event",
                    "FB",
                    "XFBML",
                    "sdk.domReady",
                    "sdk.feature",
                    "wrapFunction"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n)
                {
                    __p && __p();
                    j.provide("XFBML", {
                        parse: function p(q)
                ...
                __d("IframePlugin", ["sdk.Auth",
                    ...
                    "sdk.feature",
                    "guid",
                    "resolveURI"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x)
                {
                    __p && __p();
                    var y = {
                        skin: "string",
                    ...
                    function z(H, I, J)
                    {
                        if (I || I === 0)if (I === "100%")H.style.width = "100%";
                    ...
                    var G = p.extend({
                        ...
                        {
                            __p && __p();
                            var J = i.getPosition(this._iframe).x, K = i.getViewportInfo().width, L = parseInt(i.getStyle(this._iframe, "width"), 10), M = {};
                            if (J + I > K && J > I)
                            {
                ...
                __d("PluginTags", ["PluginAttrTypes"], (function a(b, c, d, e, f, g, h)
                {
                    var i = {
                        comment_embed: {
                            href: h.url,
                            include_parent: h.bool
                        },
                        composer: {
                            action_type: h.string,
                            action_properties: h.string
                        },
                        create_event_button: {},
                        group: {
                            href: h.url,
                ...
                __d("sdk.XFBML.Element", ["sdk.DOM",
                    "Type",
                    "ObservableMixin"], (function a(b, c, d, e, f, g, h, i, j)
                {
                    __p && __p();
                    var k = i.extend({
                ...
                __d("sdk.XFBML.IframeWidget", ["sdk.Arbiter",
                    ...
                    "sdk.ui",
                    "UrlMap",
                    "sdk.XD"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t)
                {
                    __p && __p();
                    var u = m.extend({
                        _iframeName: null,
                        ...
                        {
                            __p && __p();
                            var y = this.getIframeNode(), z = parseInt(k.getStyle(y, "width"), 10), A = k.getPosition(y).x, B = k.getViewportInfo().width, C = parseInt(x.width, 10);
                            if (A + C > B && A > C)
                            {
                                y.style.left = z - C + "px";
                ...
                __d("sdk.XFBML.Comments", ["sdk.Event",
                    "sdk.XFBML.IframeWidget",
                    "QueryString",
                    "sdk.Runtime",
                    "JSSDKConfig",
                    "sdk.UA",
                    "UrlMap"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n)
                {
                    __p && __p();
                ...
                __d("sdk.XFBML.CommentsCount", ["ApiClient",
                    "sdk.DOM",
                    "sdk.XFBML.Element",
                    "sprintf"], (function a(b, c, d, e, f, g, h, i, j, k)
                {
                    __p && __p();
                    var l = j.extend({
                        process: function m()
                ...
                {
                    "use strict";
                    var h = typeof navigator !== "undefined" && ES(navigator.userAgent, "indexOf", true, "AppleWebKit") > -1;

                    function i(j)
                    {
                        j = j || document;
                        if (j.scrollingElement)return j.scrollingElement;
                ...
                __d("sdk.XFBML.CustomerChat", ["sdk.Content",
                    "sdk.DialogUtils",
                    "sdk.DocumentTitle",
                    "sdk.DOM",
                    "DOMEventListener",
                    ...
                    "sdk.createIframe",
                    "sdk.feature",
                    "getDocumentScrollElement"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t)
                {
                    "use strict";
                    __p && __p();
                    var u = ["animationend",
                        ...
                        "MSAnimationEnd",
                        "oAnimationEnd",
                        "webkitAnimationEnd"], v = null, w = null, x = false, y = null, z = "", A = 0, B = 0, C = null, D = n.extend({
                        constructor: function I(J, K, L, M)
                        {
                            __p && __p();
                            k.addCss(J, "fb_invisible_flow");
                            k.remove(J);
                            h.append(J);
                            this.parent(J, K, L, M);
                            this._iframeOptions.title = "";
                            m.fire("customerchat.load");
                            this.subscribe("xd.liveChatPluginGetBubbleIframe", ES(function (N)
                            {
                                this._bubbleDialog = this._setupNewIframeDialog(N.fromIframe, ES("JSON", "parse", false, N.isHTTPS));
                                w = this._bubbleDialog;
                                h.append(this._bubbleDialog);
                                this.subscribe("xd.liveChatPluginShowBubbleIframe", ES(function (N)
                                {
                                    k.setStyle(this._bubbleDialog, "display", "inline");
                                    if (ES("JSON", "parse", false, N.showBadge))this._setBubbleBadgeStyle()
                                }, "bind", true, this))
                            }, "bind", true, this));
                            this.subscribe("xd.liveChatPluginPrepareDesktopAnchorIframe", ES(function (N)
                            {
                                if (this._iframe)
                                {
                                    ...
                                    ES("Object", "assign", false, this._iframe.style, {
                                        ...
                                        maxHeight: ES("JSON", "parse", false, N.dialogHidden) ? "0" : "100%",
                                        padding: "0",
                                        position: "fixed",
                                        right: "18pt",
                                        top: "auto",
                                    ...
                                    if (ES("JSON", "parse", false, N.chatStarted))
                                    {
                                        x = true;
                                        ES("Object", "assign", false, this._iframe.style, {height: "360pt"})
                                    }
                                    y = this._iframe
                                }
                            }, "bind", true, this));
                            this.subscribe("xd.liveChatPluginPrepareMobileAnchorIframe", ES(function (N)
                            {
                                __p && __p();
                                if (this._iframe)
                                {
                                    ...
                                    if (ES("JSON", "parse", false, N.chatStarted))
                                    {
                                        ...
                                        if (!ES("JSON", "parse", false, N.dialogHidden))E()
                                    }
                            ...
                            this.subscribe("xd.liveChatPluginResizeAnchorIframe", ES(function (N)
                            {
                                this._iframe && k.setStyle(this._iframe, "height", ES("JSON", "parse", false, N.height) + "px")
                            }, "bind", true, this));
                            this.subscribe("xd.liveChatPluginExpandDesktopDialogIframe", ES(function (N)
                            {
                                x = true;
                                this._iframe && k.setStyle(this._iframe, "height", "360pt")
                            }, "bind", true, this));
                            this.subscribe("xd.liveChatPluginExpandMobileDialogIframe", ES(function (N)
                            {
                                __p && __p();
                                x = true;
                                if (this._iframe)
                                {
                                    k.setStyle(this._iframe, "boxShadow", "none");
                            ...
                            this.subscribe("xd.liveChatPluginShowDialogIframe", ES(function (N)
                            {
                                G(this._iframe, ES("JSON", "parse", false, N.chatStarted), ES("JSON", "parse", false, N.isMobile))
                            }, "bind", true, this));
                            this.subscribe("xd.liveChatPluginHideDialogIframe", ES(function (N)
                            {
                                H(this._iframe, ES("JSON", "parse", false, N.chatStarted), ES("JSON", "parse", false, N.isMobile))
                            }, "bind", true, this));
                            this.subscribe("xd.liveChatPluginResetShadow", ES(function (N)
                            {
                                if (ES("JSON", "parse", false, N.resetShadow) && this._bubbleDialog)
                                {
                                    k.setStyle(this._bubbleDialog, "boxShadow", "0px 3px 12px rgba(0, 0, 0, 0.15)");
                                    k.setStyle(this._bubbleDialog, "borderRadius", "50%")
                                }
                                else if (ES("JSON", "parse", false, N.dialogHidden))this._setBubbleBadgeStyle()
                            }, "bind", true, this));
                            this.subscribe("xd.liveChatPluginUpdatePageTitle", ES(function (N)
                            {
                                if (!v && N.titleText)
                                {
                                    v = j.blink(N.titleText);
                                    l.add(window, "focus", ES(function (O)
                                    {
                                        this._stopBlinking()
                                    }, "bind", true, this))
                                }
                                else if (v && !N.titleText)this._stopBlinking()
                            }, "bind", true, this));
                            if (p.iphone())
                            {
                                this.subscribe("xd.liveChatPluginFocusComposer", ES(function (N)
                                {
                                    setTimeout(ES(function ()
                                    {
                                        ...
                                        if (O)
                                        {
                                            k.setStyle(this._iframe, "maxHeight", O.scrollHeight - O.scrollTop + "px");
                                            O.scrollTo(0, 0)
                                        }
                                    }, "bind", true, this), 700)
                                }, "bind", true, this));
                                this.subscribe("xd.liveChatPluginBlurComposer", ES(function (N)
                                {
                                    k.setStyle(this._iframe, "maxHeight", "100%")
                                }, "bind", true, this))
                            }
                            m.subscribe("customerchat.load", ES(function ()
                            {
                                k.remove(J);
                                k.remove(this._bubbleDialog)
                            }, "bind", true, this))
                        },
                        _setupNewIframeDialog: function I(J, K)
                        {
                            var L = "#" + o.encode({forIframe: J}), M = i.setupNewDialog();
                            k.setStyle(M.contentRoot, "background", "none");
                            z = this._iframeOptions.name;
                            r({
                                url: q.getXDArbiterURL(K) + L,
                            ...
                            ES("Object", "assign", false, M.dialogElement.style, {
                                background: "none",
                                borderRadius: "50%",
                                bottom: "18pt",
                            ...
                            return M.dialogElement
                        },
                        _setBubbleBadgeStyle: function I()
                        {
                    ...
                    function E()
                    {
                        A = window.pageXOffset !== undefined ? window.pageXOffset : document.documentElement && document.documentElement.scrollLeft;
                        B = window.pageYOffset !== undefined ? window.pageYOffset : document.documentElement && document.documentElement.scrollTop;
                    ...
                    {
                        __p && __p();
                        var L = arguments.length <= 3 || arguments[3] === undefined ? true : arguments[3];
                        if (!I)return;
                        if (C === null || C === false)
                        {
                            if (K && J)E();
                            k.removeCss(I, "fb_customer_chat_bounce_out");
                            k.addCss(I, "fb_customer_chat_bounce_in");
                            k.setStyle(I, "maxHeight", "100%");
                            C = true
                        }
                        if (L && s("allow_customer_chat_events", false))m.fire("customerchat.dialogShow")
                    }

                    function H(I, J, K)
                    {
                        __p && __p();
                        var L, M = arguments.length <= 3 || arguments[3] === undefined ? true : arguments[3], N = I;
                        if (!N)return;
                        if (C === null || C === true)(function ()
                        {
                            __p && __p();
                            var H = function H(O)
                            {
                                if (O.animationName === "fb_fade_out")
                                {
                                    k.setStyle(N, "maxHeight", "0");
                                    ES(u, "forEach", true, function (event)
                                    {
                                        l.remove(N, event, H)
                                    })
                                }
                            ...
                            if (K && J)F();
                            k.removeCss(N, "fb_customer_chat_bounce_in");
                            k.addCss(N, "fb_customer_chat_bounce_out");
                            ES(u, "forEach", true, function (event)
                            {
                                l.add(N, event, H)
                            });
                        ...
                        if (M && s("allow_customer_chat_events", false))m.fire("customerchat.dialogHide")
                    }

                    D.show = function ()
                    {
                        var I = arguments.length <= 0 || arguments[0] === undefined ? true : arguments[0];
                        k.setStyle(w, "display", "inline");
                        if (I)G(y, x, p.mobile(), false);
                        if (s("allow_customer_chat_events", false))m.fire("customerchat.show")
                    };
                    D.hide = function ()
                    {
                        k.setStyle(w, "display", "none");
                        H(y, x, p.mobile(), false);
                        if (s("allow_customer_chat_events", false))m.fire("customerchat.hide")
                    };
                    D.showDialog = function ()
                    {
                        G(y, x, p.mobile())
                    };
                    D.hideDialog = function ()
                    {
                        H(y, x, p.mobile())
                    };
                    D.update = function (I)
                    {
                        q.sendToFacebook(z, {
                            ...
                            params: ES("JSON", "stringify", false, I || {})
                        })
                    };
                    f.exports = D
                }), null);
                ...
                __d("sdk.Helper", ["sdk.ErrorHandling",
                    "sdk.Event",
                    "UrlMap",
                    "safeEval",
                    "sprintf"], (function a(b, c, d, e, f, g, h, i, j, k, l)
                {
                    __p && __p();
                    var m = {
                        isUser: function n(o)
                        ...
                        {
                            if (o)if (typeof o === "string")h.unguard(k)(o, q);
                ...
                __d("sdk.XFBML.LoginButton", ["sdk.Helper",
                    "IframePlugin",
                    "Log",
                    "sdk.ui",
                    "sdk.XD"], (function a(b, c, d, e, f, g, h, i, j, k, l)
                {
                    __p && __p();
                    var m = i.extend({
                ...
                __d("sdk.XFBML.Name", ["ApiClient",
                    "escapeHTML",
                    "sdk.Event",
                    "sdk.XFBML.Element",
                    "sdk.Helper",
                    "Log",
                    "sdk.Runtime"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n)
                {
                    __p && __p();
                    var o = {}.hasOwnProperty, p = k.extend({
                        ...
                        _renderPronoun: function q(r)
                        {
                            ...
                            if (this._uid == n.getUserID() && this._getBoolAttribute("use-you", true))if (this._possessive)if (this._reflexive)s = "your own";
                            else s = "your";
                            ...
                            else switch (r.gender)
                            {
                                ...
                                case"female":
                                    ...
                                    break;
                                default:
                                    if (this._getBoolAttribute("use-they", true))if (this._possessive)if (this._reflexive)s = "their own";
                                    else s = "their";
                                    else if (this._reflexive)s = "themselves";
                                    else if (t)s = "them";
                                    else s = "they";
                                    else if (this._possessive)if (this._reflexive)s = "his/her own";
                                    else s = "his/her";
                        ...
                        _renderOther: function q(r)
                        {
                            __p && __p();
                            var s = "", t = "";
                            if (this._uid == n.getUserID() && this._getBoolAttribute("use-you", true))if (this._reflexive)if (this._possessive)s = "your own";
                            else s = "yourself";
                ...
                __d("sdk.XFBML.Quote", ["sdk.DOM",
                    ...
                    "sdk.XD",
                    "containsNode",
                    "sdk.feature"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o)
                {
                    "use strict";
                    __p && __p();
                    ...
                    {
                        __p && __p();
                        var E = w && w.offsetWidth, F = E ? w.offsetHeight : r, G = E ? w.offsetWidth : q, H = D.getRangeAt(0), I = document.createElement("span"), J = document.createElement("span"), K = document.createRange();
                ...
                __d("sdk.XFBML.Save", ["sdk.Content",
                    "sdk.DialogUtils",
                    "sdk.DOM",
                    "sdk.Event",
                    "IframePlugin",
                    ...
                    "sdk.UA",
                    "sdk.XD",
                    "sdk.createIframe"], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p)
                {
                    "use strict";
                    __p && __p();
                ...
                __d("sdk.XFBML.ShareButton", ["IframePlugin",
                    "sdk.UA",
                    "sdk.ui"], (function a(b, c, d, e, f, g, h, i, j)
                {
                    "use strict";
                    var k = h.extend({
                ...
                __d("legacy:fb.xfbml.plugins", ["IframePlugin",
                    "PluginConfig",
                    "PluginTags",
                    "XFBML",
                    "sdk.feature",
                    ...
                    "sdk.XFBML.Video"], (function a(b, c, d, e, f, g, h, i, j, k, l)
                {
                    var m = {
...
{
    new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"3815795","namespace":"FB","message":"' + e.message + '"}}');
}