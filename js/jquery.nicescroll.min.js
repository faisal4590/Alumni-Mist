...
(function (d) {
    var s = false, w = false, B = 5E3, C = 2E3, D = function () {
        ...
        r = window.cancelRequestAnimationFrame || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame ||
            window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || false, x = false,
        E = function () {
            if (x)
            {
                return x;
            ...
            if (c.hastransform)
            {
                d.style[c.trstyle] = "translate3d(1px,2px,3px)", c.hastranslate3d = /translate3d/.test(d.style[c.trstyle]);
            }
            c.transitionstyle = false;
            c.prefixstyle = "";
            c.transitionend = false;
            ...
            function i(f, c)
            {
                ...
                if ("wheelDeltaY" in f)
                {
                    g = Math.floor(f.wheelDeltaX / 2), e = Math.floor(f.wheelDeltaY / 2);
                }
                else
                {
            ...
            this.updateScrollBar = function (f) {
                ...
                else
                {
                    ...
                    if (b.railh && !b.locked)
                    {
                        g = c.top, e = c.left, f = b.railh.align ? g + h(b.win, "border-top-width", true) + b.win.innerHeight() - b.railh.height : g + h(b.win, "border-top-width", true), e += h(b.win, "border-left-width"), b.railh.css({
                            top: f,
                            left: e,
                            width: b.railh.width
                        })
            ...
            this.init = function () {
                ...
                if (!b.ispage || !e.cantouch && !e.isieold && !e.isie9mobile)
                {
                    ...
                    if (b.opt.boxzoom && !b.ispage && !e.isieold && (c = document.createElement("div"), b.bind(c, "click", b.doZoom), b.zoom = d(c), b.zoom.css({
                        ...
                        }), b.opt.dblclickzoom && b.bind(b.win, "dblclick", b.doZoom), e.cantouch && b.opt.gesturezoom))
                    {
                    ...
                    b.ispage ? (g.css({
                        ...
                        top: "0px",
                        height: "100%"
                    }), g.align ? g.css({right: "0px"}) : g.css({left: "0px"}), b.body.append(g), b.railh && (k.css({
                        position: "fixed",
                        left: "0px",
                        width: "100%"
                    }), k.align ? k.css({bottom: "0px"}) : k.css({top: "0px"}), b.body.append(k))) : (b.ishwscroll ? (b.win.css("position") == "static" && b.css(b.win, {position: "relative"}), f = b.win[0].nodeName ==
                    "HTML" ? b.body : b.win, b.zoom && (b.zoom.css({
                        ...
                        position: "absolute",
                        top: 0
                    }), g.align ? g.css({right: 0}) : g.css({left: 0}), f.append(g), k && (k.css({
                        position: "absolute",
                        left: 0,
                        bottom: 0
                    }), k.align ? k.css({bottom: 0}) : k.css({top: 0}), f.append(k))) : (b.isfixed = b.win.css("position") == "fixed", f = b.isfixed ? "fixed" : "absolute", g.css({position: f}), b.zoom && b.zoom.css({position: f}), b.updateScrollBar(), b.body.append(g), b.zoom && b.body.append(b.zoom),
                    b.railh && (k.css({position: f}), b.body.append(k))), e.isios && b.css(b.win, {
                        "-webkit-tap-highlight-color": "rgba(0,0,0,0)",
                        "-webkit-touch-callout": "none"
                    }), e.isie && b.opt.disableoutline && b.win.attr("hideFocus", "true"), e.iswebkit && b.opt.disableoutline && b.win.css({outline: "none"}));
                    ...
                    if (e.isie9mobile)
                    {
                        b.scrollmom = new z(b), b.onmangotouch = function () {
                                    ...
                                    2) + Math.pow(g, 2))) != 0)
                            {
                                ...
                                {
                                    b.scrollmom.stop(), b.scrollmom.reset(f, c), b.mangotouch.sy = c, b.mangotouch.ly = c, b.mangotouch.sx = f, b.mangotouch.lx = f, b.mangotouch.dry = l, b.mangotouch.drx = d, b.mangotouch.tm = h;
                                }
                                        ...
                                        f)), b.mangotouch.ly = c, b.mangotouch.lx = f, g > 2)
                                {
                    ...
                    else
                    {
                        if (e.cantouch || b.istouchcapable || b.opt.touchbehavior || e.hasmstouch)
                        {
                            ...
                            b.ontouchstart = function (c) {
                                ...
                                if (!b.locked)
                                {
                                    ...
                                    if (b.forcescreen)
                                    {
                                        g = c, c = {original: c.original ? c.original : c}, c.clientX = g.screenX, c.clientY = g.screenY;
                                    }
                                    b.rail.drag = {
                                        x: c.clientX,
                                        y: c.clientY,
                                    ...
                                    if (!e.cantouch && !this.istouchcapable && !e.hasmstouch)
                                    {
                                        ...
                                        {
                                            return !b.ispage && e.hasmousecapture && f.setCapture(), b.cancelEvent(c);
                                        }
                            ...
                            b.ontouchend =
                                function (c) {
                                    ...
                                    if (b.rail.drag && b.rail.drag.pt == 2 && (b.scrollmom.doMomentum(), b.rail.drag = false, b.hasmoving && (b.hasmoving = false, b.lastmouseup = true, b.hideCursor(), e.hasmousecapture && document.releaseCapture(), !e.cantouch)))
                                    {
                                        return b.cancelEvent(c)
                                    }
                                };
                        ...
                        e.cantouch || b.opt.touchbehavior ? (b.onpreventclick = function (c) {
                            if (b.preventclick)
                            {
                                return b.preventclick.tg.onclick = b.preventclick.click, b.preventclick = false, b.cancelEvent(c)
                            }
                            ...
                            if (!(b.rail.drag && b.rail.drag.pt != 1))
                            {
                                ...
                                {
                                    b.saved.csspointerevents = b.doc.css("pointer-events"), b.css(b.doc, {"pointer-events": "none"});
                                }
                                return b.cancelEvent(c)
                            }
                        }, b.onmouseup =
                            function (c) {
                                if (b.rail.drag && (e.hasmousecapture && document.releaseCapture(), b.isiframe && !e.hasmousecapture && b.doc.css("pointer-events", b.saved.csspointerevents), b.rail.drag.pt == 1))
                                {
                        ...
                        b.railh && (b.bind(b.cursorh, "mousedown", function (c) {
                            ...
                            if (!(b.rail.drag && b.rail.drag.pt == 2))
                            {
                                return b.rail.drag = false, b.hasmoving = false, b.hideCursor(), e.hasmousecapture && document.releaseCapture(), b.cancelEvent(c)
                            }
                        }));
                    ...
                    b.onkeypress = function (c) {
                        ...
                        if (f && /INPUT|TEXTAREA|SELECT|OPTION/.test(f.nodeName) &&
                            (!f.getAttribute("type") && !f.type || !/submit|button|cancel/i.tp))
                        {
                            return true;
                        }
            ...
            this.hideCursor = function (c) {
                if (!b.cursortimeout && b.rail && b.autohidedom)
                {
                    b.cursortimeout = setTimeout(function () {
                        ...
                        {
                            b.autohidedom.stop().animate({opacity: b.opt.cursoropacitymin}), b.zoom && b.zoom.stop().animate({opacity: b.opt.cursoropacitymin}), b.cursoractive = false;
                        }
                        b.cursortimeout = 0
                    }, c || 400)
                }
            ...
            this.onResize = function (c, e) {
                ...
                if (b.page.maxh == g && b.page.maxw == d && b.view.w == h)
                {
                    ...
                    {
                        g = b.win.offset();
                        if (b.lastposition && (d = b.lastposition, d.top == g.top && d.left == g.left))
                        {
                            return b;
                        }
                        b.lastposition = g
            ...
            this.bind = function (c, d, g, h) {
                ...
                b._bind(i, d == "mousedown" ? "touchstart" : d == "mouseup" ? "touchend" : "touchmove", function (b) {
                    ...
                    {
                        c = b.changedTouches[0], c.original = b, g.call(this, c)
                    }
            ...
            this.showRail = function () {
                ...
                {
                    b.visibility = true, b.rail.visibility = true, b.rail.css("display", "block");
                }
                return b
            };
            this.showRailHr = function () {
                ...
                if (b.page.maxw !=
                    0 && (b.ispage || b.win.css("display") != "none"))
                {
                ...
                b.timer = setTimeout(function () {
                    ...
                    if (i > 0)
                    {
                        ...
                        if (e.transitionend)
                        {
                            ...
                            {
                                b.scrollendtrapped = true, b.bind(b.doc, e.transitionend, b.onScrollEnd, false)
                            }
                        }
                        else
                        {
            ...
            this.doZoomIn = function (c) {
                if (!b.zoomactive)
                {
                    ...
                    if (e.isios4)
                    {
                        b.zoomrestore.scrollTop = d(window).scrollTop(), d(window).scrollTop(0);
                    }
                    b.win.css({
            ...
            this.doZoomOut = function (c) {
                if (b.zoomactive)
                {
                    return b.zoomactive = false, b.win.css("margin", ""), b.win.css(b.zoomrestore.style), e.isios4 && d(window).scrollTop(b.zoomrestore.scrollTop), b.rail.css({"z-index": b.ispage ? b.opt.zindex : b.opt.zindex + 2}), b.zoom.css({"z-index": b.opt.zindex}), b.zoomrestore = false, b.zoom.css("backgroundPosition", "0px 0px"), b.onResize(), b.onzoomout && b.onzoomout.call(b),
                        b.cancelEvent(c)
                }
            };
                ...
                if (c.speedy && b && c.speedy || d)
                {
                    ...
                    var f = c.lastscrollx, l = c.lastscrolly, g = function () {
                        ...
                        if (c.speedx && (f = Math.floor(c.lastscrollx -
                                c.speedx * (1 - c.demulxy)), c.lastscrollx = f, f < 0 || f > n))
                        {
                            b = 0.1;
                        }
                        if (c.speedy && (l = Math.floor(c.lastscrolly - c.speedy * (1 - c.demulxy)), c.lastscrolly = l, l < 0 || l > e))
                        {
                            b = 0.1;
                        }
                        ...
                        c.nc.synched("domomentum2d", function () {
                            if (c.speedx)
                            {
                                c.nc.getScrollLeft() != c.chkx && c.stop(), c.chkx = f, c.nc.setScrollLeft(f);
                            }
                            if (c.speedy)
                            {
    ...
    d.fn.niceScroll = function (j, c) {
        ...
        this.each(function () {
            ...
            if (!b)
            {
                c.doc = i ? d(this) : c.doc, b = new F(c, d(this)), d(this).data("__nicescroll", b);
            }
            h.push(b)
        });
