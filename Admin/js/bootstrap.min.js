...
+function (a) {
    ...
    c.VERSION = "3.3.7", c.TRANSITION_DURATION = 600, c.DEFAULTS = {
        ...
        if (this.$element.trigger(k), !k.isDefaultPrevented())
        {
            ...
            return a.support.transition && this.$element.hasClass("slide") ? (f.addClass(b), f[0].offsetWidth, e.addClass(h), f.addClass(h), e.one("bsTransitionEnd", function () {
                f.removeClass([b,
                    h].join(" ")).addClass("active"), e.removeClass(["active",
                    h].join(" ")), i.sliding = !1, setTimeout(function () {
                    i.$element.trigger(m)
                }, 0)
    ...
    c.VERSION = "3.3.7", c.TRANSITION_DURATION = 150, c.DEFAULTS = {
        ...
        var f = window.SVGElement && c instanceof window.SVGElement, g = d ? {
            ...
            h = {scroll: d ? document.documentElement.scrollTop || document.body.scrollTop : b.scrollTop()}, i = d ? {
