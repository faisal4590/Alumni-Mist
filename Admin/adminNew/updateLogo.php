...
<body>
    ...
    <div class="container" style="margin: 0 auto; width: 600px;;">
        <div class="row">
            <form method="post" action="processUpdateLogo.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        ?>
                        <input type="text" class="form-control" name="updateLogoTitle" value="<?php echo $row['logo_title'];?>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <br>
                    <img src="../../images/updateLogo/<?php echo $row['logo_image'];?>" alt="" height="70" width="100">

                    <input type="file"  name="updateLogo">
                </div>
