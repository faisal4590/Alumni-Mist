...
(10, 'Pahela Baishakh', 'MIST', '2018-07-25 14:00:00', '2', 'Pahela baishakh event', 'baishakh.jpg', 0);
...
(5, 'Naved Ul Hasan', 'naved123', 'naved', 'naved@gmail.com', '01851201537', '', '', '', '', 'cse', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'mine2.jpg', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, '', '', '', ''),
...
(8, 1, 'optimizedfaisal42@gmail.com', '15', 'Pahela Baishakh', 'Your ticket request for Pahela Baishakh has been accepted. Check your email to get the ticket.');
...
(8, 1, 9, 'Pohela Baisakh', '2', '2018-05-14 14:03:00', 'FB_IMG_1521193959473.jpg', 'MIST lawn', 'Mela', '                        optimized', '                    optimized faisal', 'optimizedfaisal42@gmail.com', 'mine.jpg', '                    optimized faisal would like to request an account.', '2018-05-11 13:40:38'),
...
--
ALTER TABLE `chat_history`
  MODIFY `chat_id` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `timeline_post`
  MODIFY `post_id` int(14) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `upcoming_events`
--
ALTER TABLE `upcoming_events`
  MODIFY `upcoming_event_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
